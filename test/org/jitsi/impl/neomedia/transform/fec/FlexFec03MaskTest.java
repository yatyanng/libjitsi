...
public class FlexFec03MaskTest {
	...
	public void testTooShortBuffer() {
		...
		final byte[] maskData = { K_BIT_0 | 0x00 };
	...
	@Test
	public void testCreateFlexFecMaskShort() throws Exception {
	...
	@Test
	public void testSeqNumRollover() throws Exception {
	...
	@Test
	public void testCreateFlexFecMaskMed() throws Exception {
	...
	@Test
	public void testCreateFlexFecMaskLong() throws Exception {
		List<Integer> expectedProtectedSeqNums = Arrays.asList(0, 1, 3, 5, 14, 15, 20, 24, 45, 108);
		int baseSeqNum = 0;
		FlexFec03Mask mask = new FlexFec03Mask(baseSeqNum, expectedProtectedSeqNums);
	 ...
	 * from a given set of sequence numbers, we can use that in the following tests
	 * to create the expected mask from a set of sequence numbers via the
	 * FlexFec03Mask methods we tested above
	 */
	private FlexFec03BitSet getMask(int baseSeqNum, List<Integer> protectedSeqNums) throws Exception {
	...
	@Test
	public void testFlexFecMaskShortFromBuffer() throws Exception {
		List<Integer> expectedProtectedSeqNums = Arrays.asList(0, 2, 5, 9, 10, 12, 14);
	...
	@Test
	public void testFlexFecMaskMedFromBuffer() throws Exception {
		List<Integer> expectedProtectedSeqNums = Arrays.asList(0, 2, 5, 9, 10, 12, 14, 15, 22, 32, 45);
	...
	@Test
	public void testFlexFecMaskLong() throws Exception {
		List<Integer> expectedProtectedSeqNums = Arrays.asList(0, 2, 5, 9, 10, 12, 14, 15, 22, 32, 45, 46, 56, 66, 76,
				90, 108);
	...
	@Test
	public void testFlexFecTooBigDelta() throws Exception {
		List<Integer> expectedProtectedSeqNums = Arrays.asList(109);
