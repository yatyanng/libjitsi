...
public class DOMElementWriter {
	 ...
	 * @return a <tt>String</tt> which represents <tt>name</tt> decoded according to
	...
	public static String decodeName(String name) {
		...
		for (int i = 0; i < length;) {
			...
			/*
			 * We may have to decode from start (inclusive). Append from i to start
			 * (exclusive).
			 */
			if (i != start)
			...
			if ((end < length) && (name.charAt(start + 1) == 'x') && (name.charAt(end) == '_')
					&& isHexDigit(name.charAt(start + 2)) && isHexDigit(name.charAt(start + 3))
					&& isHexDigit(name.charAt(start + 4)) && isHexDigit(name.charAt(start + 5))) {
				 ...
				 * the first place? We don't want to accidentally decode a string just because
				 * it looked like an encoded character.
				 */
	...
	/**
	 * Encodes a specific <tt>String</tt> so that it is a valid XML (element) name
	 * according to http://www.w3.org/TR/xml/#NT-Name.
	 *
	 * @param value the <tt>String</tt> to be encoded so that it is a valid XML name
	 * @return a <tt>String</tt> which represents <tt>value</tt> encoded so that it
	 *         is a valid XML (element) name
	 */
	...
	/**
	 * Determines whether a specific characters is a <tt>NameChar</tt> as defined by
	 * http://www.w3.org/TR/xml/#NT-Name.
	 *
	 ...
	 *          <tt>NameStartChar</tt>
	 * @return <tt>true</tt> if the specified character is a <tt>NameStartChar</tt>;
	 *         otherwise, <tt>false</tt>
	 */
...
//            return true;
	 ...
	 * &lt;?xml version='1.0' encoding='UTF-8'?&gt;. The indent number is set to 0
	...
	/**
	 * Escape &lt;, &gt; &amp; &apos;, &quot; as their entities and drop characters
	 * that are illegal in XML documents.
	 *
	 ...
	 *
	 * <p>
	 * Also ensure that we are not including an <tt>]]&gt;</tt> marker by replacing
	 * that sequence with <tt>&amp;#x5d;&amp;#x5d;&amp;gt;</tt>.
	 * </p>
	 *
	 * <p>
	 * See XML 1.0 2.2 <a href=
	 * "http://www.w3.org/TR/1998/REC-xml-19980210#charsets">http://www.w3.org/TR/1998/REC-xml-19980210#charsets</a>
	 * and 2.7 <a href=
	 * "http://www.w3.org/TR/1998/REC-xml-19980210#sec-cdata-sect">http://www.w3.org/TR/1998/REC-xml-19980210#sec-cdata-sect</a>.
	 * </p>
	 *
	 * @param value the value to encode
	 *
	 ...
	 * <p>
	 * See XML 1.0 2.2
	 * <a href="http://www.w3.org/TR/1998/REC-xml-19980210#charsets">
