...
public class ConfigUtils {
	 ...
	 * <tt>ConfigurationService.PNAME_SC_HOME_DIR_NAME</tt>, <tt>user.home</tt>, or
	 * the current working directory.
	 *
	 * @param path the absolute or relative path in the form of <tt>String</tt>
	 *             for/from which an absolute path in the form of <tt>File</tt> is
	 *             to be returned
	 * @param cfg  the <tt>ConfigurationService</tt> to be employed by the method
	 *             (invocation) if necessary
	 * @return an absolute path in the form of <tt>File</tt> for/from the specified
	 *         <tt>path</tt>
	 */
	 ...
	 *                     {@code null} if the property is to be retrieved from
	 *                     {@code System}
	...
	public static boolean getBoolean(ConfigurationService cfg, String property, boolean defaultValue) {
		...
		if (cfg == null) {
			...
			b = (s == null || s.length() == 0) ? defaultValue : Boolean.parseBoolean(s);
		} else {
	 ...
	 * @param defaultValue the value to be returned if {@code property} is not
	 *                     associated with a value
	 * @return the value as an {@code int} of {@code property} retrieved from either
	 *         {@code cfg} or {@code System}
	 */
	 ...
	 * {@code ConfigurationService} or {@code System}.
	 *
	 * @param cfg                 the {@code ConfigurationService} to get the value
	 *                            from or {@code null} if the property is to be
	 *                            retrieved from {@code System}
	 * @param property            the name of the property to get
	 * @param propertyAlternative an alternative name of the property
	 * @param defaultValue        the value to be returned if {@code property} is
	 *                            not associated with a value
	 * @return the value as a {@code String} of {@code property} retrieved from
	 *         either {@code cfg} or {@code System}
	 */
	public static String getString(ConfigurationService cfg, String property, String propertyAlternative,
			String defaultValue) {
