...
public class InstanceLogger extends Logger {
	...
	/**
	 * The {@link Logger} used for configuring the level. Messages are logged iff:
	 * 1. {@link #levelDelegate} is not set or allows it. 2.
	 * {@link #loggingDelegate} allows it. 3. {@link #level}, is not set or allows
	 * it.
	 */
	...
	/**
	 * Initializes an {@link InstanceLogger} instance with the given delegate for
	 * logging and for getting the level.
	 */
	...
	public Level getLevel() {
		return higher(higher(level != null ? level : Level.ALL, loggingDelegate.getLevel()),
	...
	/**
	 * @return the higher of two logging levels. e.g.: higher(Level.FINE,
