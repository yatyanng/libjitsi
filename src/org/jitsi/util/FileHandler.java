...
public class FileHandler extends java.util.logging.FileHandler {
	...
	/**
	 * Specifies a pattern for generating the output file name. A pattern consists
	 * of a string that includes the special components that will be replaced at
	 * runtime such as : %t, %h, %g, %u. Also adds the special component : %s
	 * sip-communicator's home directory, typically -
	 ...
	 * (approximately) the given limit has been written to one file, another file
	 * will be opened. The output will cycle through a set of count files.
	 * <p>
	 * The <tt>FileHandler</tt> is configured based on <tt>LogManager</tt>
	 * properties (or their default values) except that the given pattern argument
	 * is used as the filename pattern, the file limit is set to the limit argument,
	 * and the file count is set to the given count argument.
	 * <p>
	 ...
	 * @exception IOException              if there are IO problems opening the
	 *                                     files.
	...
	/**
	 * Construct a default <tt>FileHandler</tt>. This will be configured entirely
	 * from <tt>LogManager</tt> properties (or their default values). Will change
	 * <p>
	 * 
