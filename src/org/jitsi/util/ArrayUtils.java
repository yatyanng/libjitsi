...
public final class ArrayUtils {
	/**
	 * Adds a specific element to a specific array with a specific component type if
	 * the array does not contain the element yet.
	 * 
	...
	/**
	 * Inserts the given element into an open (null) slot in the array if there is
	 * one, otherwise creates a new array and adds all existing elements and the
	 * given element
	 * 
	 * @param element       the element to add
	 * @param array         the array to add to, if possible
	 * @param componentType the class type of the array (used if a new one needs to
	 *                      be allocated)
	 * @param               <T> the type of the element
	 * @return an array containing all the elements in the array that was passed, as
	 *         well as the given element. May or may not be the original array.
	 */
