...
public class SoundFileUtils {
	...
	public static boolean isSoundFile(File f) {
		...
		if (ext != null) {
			return ext.equals(wma) || ext.equals(wav) || ext.equals(ram) || ext.equals(ogg) || ext.equals(mp3)
					|| ext.equals(mp2) || ext.equals(mod) || ext.equals(mid) || ext.equals(gsm) || ext.equals(au);
		}
		return false;
	}
	 ...
	 *
	 * @param f            <tt>File</tt> to check
	 * @param soundFormats The sound formats to restrict the file name extension. If
	 *                     soundFormats is null, then every sound format defined by
	 *                     SoundFileUtils is correct.
	 *
	 * @return <tt>true</tt> if it's a sound file conforming to the format given in
	 *         parameters (if soundFormats is null, then every sound format defined
	...
	/**
	 * Gets the file extension. TODO: There are at least 2 other methods like this
	 * scattered around the SC code, we should move them all to util package.
	 *
