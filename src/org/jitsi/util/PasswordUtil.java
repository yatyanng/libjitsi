...
public class PasswordUtil {
	/**
	 * The method will replace password argument values with 'X' in a string which
	 * represents command line arguments(arg=value arg2=value4).
	 *
	 ...
	 *
	 * @return <tt>cmdLine</tt> string with password argument values shadowed by 'X'
	 */
	 ...
	 * @param passwordArgs the array which contains the names of password argument
	 *                     to be shadowed.
	 * @return <tt>cmdLine</tt> string with password arguments values shadowed by
	 *         'X'
	 */
