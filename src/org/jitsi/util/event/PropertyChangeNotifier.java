...
public class PropertyChangeNotifier {
	/**
	 * The <tt>Logger</tt> used by the <tt>PropertyChangeNotifier</tt> class and its
	 * instances for logging output.
	 */
	private static final Logger logger = Logger.getLogger(PropertyChangeNotifier.class);

	/**
	 * The list of <tt>PropertyChangeListener</tt>s interested in and notified about
	 ...
	 * this <tt>PropertyChangeNotifier</tt>.
	 *
	...
	protected void firePropertyChange(String property, Object oldValue, Object newValue) {
		...
		if (ls.length != 0) {
			PropertyChangeEvent ev = new PropertyChangeEvent(getPropertyChangeSource(property, oldValue, newValue),
	 ...
	 * <tt>PropertyChangeListener</tt>s registered with this
	 * <tt>PropertyChangeNotifier</tt> about the change in the value of a property
	 * with a specific name from a specific old value to a specific new value.
	 *
	 * @param property the name of the property which had its value changed from the
	...
	/**
	 * Removes a specific <tt>PropertyChangeListener</tt> from the list of listeners
	 * interested in and notified about changes in the values of the properties of
	 * this <tt>PropertyChangeNotifer</tt>.
	 *
