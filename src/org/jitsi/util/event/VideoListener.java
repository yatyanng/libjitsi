...
public interface VideoListener extends EventListener {
	...
	/**
	 * Notifies that a visual <tt>Component</tt> representing video has been added
	 * to the provider this listener has been added to.
	 *
	...
	/**
	 * Notifies that a visual <tt>Component</tt> representing video has been removed
	 * from the provider this listener has been added to.
	 *
	 ...
	 *
	 * @param event a <tt>VideoEvent</tt> describing the visual <tt>Component</tt>
