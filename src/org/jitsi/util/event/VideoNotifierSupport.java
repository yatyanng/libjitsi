...
public class VideoNotifierSupport {
	 ...
	 * {@link #listeners} registered with this instance when {@link #synchronous} is
	 * equal to <tt>false</tt>.
	 */
	private final List<VideoEvent> events;

	/**
	 * The list of <tt>VideoListener</tt>s interested in changes in the availability
	 * of visual <tt>Component</tt>s depicting video.
	 */
	 ...
	 *                    <tt>VideoEvent</tt>s synchronously; otherwise,
	 *                    <tt>false</tt>
	 */
	...
	/**
	 * Adds a specific <tt>VideoListener</tt> to this <tt>VideoNotifierSupport</tt>
	 * in order to receive notifications when visual/video <tt>Component</tt>s are
