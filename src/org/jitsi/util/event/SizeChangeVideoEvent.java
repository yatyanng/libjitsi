...
public class SizeChangeVideoEvent extends VideoEvent {
	...
	/**
	 * The type of a <tt>VideoEvent</tt> which notifies about an update to the size
	 * of a specific visual <tt>Component</tt> depicting video.
	 */
	...
	/**
	 * Initializes a new <tt>SizeChangeVideoEvent</tt> which is to notify about an
	 * update to the size of a specific visual <tt>Component</tt> depicting video.
	 *
	 * @param source          the source of the new <tt>SizeChangeVideoEvent</tt>
	 * @param visualComponent the visual <tt>Component</tt> depicting video with the
	 *                        updated size
