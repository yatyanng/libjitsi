...
public abstract class Logger {
	 ...
	 * @param levelDelegate   the {@link Logger} used for configuring the log level.
	 */
	 ...
	 * Log a TRACE message.
	 * <p>
	 * If the logger is currently enabled for the TRACE message level then the given
	 ...
	 * Log a DEBUG message.
	 * <p>
	 * If the logger is currently enabled for the DEBUG message level then the given
	 * message is forwarded to all the registered output Handler objects.
	 * <p>
	 * 
	 * @param msg The message to log
	 ...
	 * Log a WARN message.
	 * <p>
	 * If the logger is currently enabled for the WARN message level then the given
	 * message is forwarded to all the registered output Handler objects.
	 * <p>
	 * 
	 * @param msg The message to log
	 ...
	 * Log a ERROR message.
	 * <p>
	 * If the logger is currently enabled for the ERROR message level then the given
	 * message is forwarded to all the registered output Handler objects.
	 * <p>
	 * 
	 * @param msg The message to log
	 ...
	 * Log a FATAL message.
	 * <p>
	 * If the logger is currently enabled for the FATAL message level then the given
	 * message is forwarded to all the registered output Handler objects.
	 * <p>
	 * 
	 * @param msg The message to log
	 ...
	 * at startup. So if the properties containing the log dir locations have
	 * changed, we would read the new configuration.
	 */
	public void reset() {
	}
	...
	/**
	 * Checks whether messages with a particular level should be logged according to
	 * the log level configured for this {@link Logger}.
	 * 
	...
	/**
	 * Logs a message at a given level, if that level is loggable according to the
	 * log level configured by this instance.
	 * 
	...
	/**
	 * Logs a given message with and given category at a given level, if that level
	 * is loggable according to the log level configured by this instance. An
	 * identifier of the category in the form of CAT=name will will simply be
	...
	/**
	 * Log a message with debug level. An identifier of the category in the form of
	 * CAT=name will will simply be prepended to the message.
	 * <p>
	 * 
	 * @param msg      The message to log
	 * @param category the category.
	...
	/**
	 * Log a message with debug level, with associated Throwable information. An
	 * identifier of the category in the form of CAT=name will will simply be
	 * prepended to the message.
	 * <p>
	 * 
	...
	/**
	 * Log a message with error level. An identifier of the category in the form of
	 * CAT=name will will simply be prepended to the message.
	 * <p>
	 * 
	 * @param msg      The message to log
	...
	/**
	 * Log a message with error level, with associated Throwable information. An
	 * identifier of the category in the form of CAT=name will will simply be
	 * prepended to the message.
	 * <p>
	 * 
	...
	/**
	 * Log a message with info level, with associated Throwable information. An
	 * identifier of the category in the form of CAT=name will will simply be
	 * prepended to the message.
	 * <p>
	 * 
	...
	/**
	 * Log a message with info level. An identifier of the category in the form of
	 * CAT=name will will simply be prepended to the message.
	 * <p>
	 * 
	 * @param category the category.
	...
	public enum Category {
		...
		/**
		 * The short string which identifies the category and is added to messages
		 * logged with this category.
		 */
		private String name;
