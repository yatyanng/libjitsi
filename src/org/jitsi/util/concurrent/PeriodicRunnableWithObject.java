...
public abstract class PeriodicRunnableWithObject<T> extends PeriodicRunnable {
	...
	/**
	 * Initializes a new {@code PeriodicRunnableWithObject} instance associated with
	 * a specific {@code Object}.
	 *
	 ...
	 * {@link PeriodicRunnable#_lastProcessTime} is updated and (2) removing the
	 * requirement of {@link RecurringRunnable#run()} to return a {@code long} value
	 * with unknown/undocumented (at the time of this writing) meaning.
	 */
