...
public abstract class PeriodicRunnable implements RecurringRunnable {
	...
	/**
	 * Initializes a new {@code PeriodicRunnable} instance which is to have its
	 * {@link #run()} invoked at a specific interval/period.
	 *
	 * @param period the interval/period in milliseconds at which {@link #run()} is
	 *               to be invoked
	 */
	 ...
	 * @param invokeImmediately whether to invoke the runnable immediately or wait
	 *                          for one {@code period} before the first invocation.
	 */
	...
	/**
	 * Gets the interval/period in milliseconds at which {@link #run} is to be
	 * invoked.
	 *
	 * @return the interval/period in milliseconds at which {@link #run} is to be
	 *         invoked
	 */
	...
	/**
	 * Sets the period in milliseconds at which {@link #run} is to be invoked. Note
	 * that the change may not take effect immediately.
	 * 
