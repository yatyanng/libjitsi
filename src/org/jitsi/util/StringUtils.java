...
public final class StringUtils {
	 ...
	 * camel-case formatted <tt>String</tt> to a more human-readable form (i.e. with
	 * spaces between the words).
	 *
	 * @param camelCase a camel-case (or Pascal-case) formatted <tt>String</tt> from
	 ...
	 * <tt>String</tt> value. If the two specified <tt>String</tt> values are equal
	 * to <tt>null</tt>, they are considered equal.
	 *
	 * @param s1 the first <tt>String</tt> value to check for value equality with
	 *           the second
	 * @param s2 the second <tt>String</tt> value to check for value equality with
	 *           the first
	 * @return <tt>true</tt> if the two specified <tt>Sting</tt> values are equal;
	 ...
	 * @return <tt>true</tt> if the given string contains letters; <tt>false</tt>,
	 *         otherwise
	 */
	...
	/**
	 * Removes all spaces from the given string and returns a concatenated result
	 * string.
	 *
	...
	/**
	 * Initializes a new <tt>String</tt> instance by decoding a specified array of
	 * bytes (mostly used by JNI).
	 *
	 * @param bytes the bytes to be decoded into characters/a new <tt>String</tt>
	 *              instance
	 * @return a new <tt>String</tt> instance whose characters were decoded from the
	 *         specified <tt>bytes</tt>
	 */
