...
public class TimeUtils {
	/**
	 * Taken from org.apache.commons.net.ntp.TimeStamp. baseline NTP time if bit-0=0
	 * is 7-Feb-2036 @ 06:28:16 UTC
	 */
	protected static final long msb0baseTime = 2085978496000L;

	/**
	 * Taken from org.apache.commons.net.ntp.TimeStamp. baseline NTP time if bit-0=1
	 * is 1-Jan-1900 @ 01:00:00 UTC
	 */
	...
	/**
	 * Taken from from org.apache.commons.net.ntp.TimeStamp#toNtpTime(long) Convert
	 * 64-bit NTP timestamp to Java standard time.
	 *
	 * Note that java time (milliseconds) by definition has less precision then NTP
	 * time (picoseconds) so converting NTP timestamp to java time and back to NTP
	 * timestamp loses precision. For example, Tue, Dec 17 2002 09:07:24.810 EST is
	 * represented by a single Java-based time value of f22cd1fc8a, but its NTP
	...
	/**
	 * Converts the given timestamp in NTP Timestamp Format into NTP Short Format
	 * (see {@link "http://tools.ietf.org/html/rfc5905#section-6"}).
	 *
	 ...
	 * {@link "http://tools.ietf.org/html/rfc5905#section-6"}) into milliseconds.
	 * 
	...
	/**
	 * Gets the most significant word (32bits) from an NTP Timestamp represented as
	 * a long.
	 * 
	...
	/**
	 * Gets the least significant word (32bits) from an NTP Timestamp represented as
	 * a long.
	 *
	 * @param ntpTime the timestamp in NTP Timestamp Format.
