...
public class PortAudioException extends Exception {
	...
	/**
	 * The code of the error as defined by the native PortAudio library represented
	 * by this instance if it is known or {@link Pa#paNoError} if it is not known.
	 */
	private final long errorCode;

	/**
	 * The host API, if any, which returned the error code and (detailed) message
	 * represented by this instance.
	 */
	private final Pa.HostApiTypeId hostApiType;

	/**
	 * Initializes a new <tt>PortAudioException</tt> instance with a specific detail
	 * message.
	 *
	 ...
	 *         represented by this instance if it is known or {@link Pa#paNoError}
	 *         if it is not known
	 */
	 ...
	 *
	 * @return the host API, if any, which returned the error code and (detailed)
	 *         message represented by this instance; otherwise, <tt>null</tt>
	 */
