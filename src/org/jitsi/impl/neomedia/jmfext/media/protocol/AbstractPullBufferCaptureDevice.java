...
public abstract class AbstractPullBufferCaptureDevice extends PullBufferDataSource implements CaptureDevice {
	 ...
	 * this <tt>AbstractPullBufferCaptureDevice</tt>.
	 */
	...
	/**
	 * Initializes a new <tt>AbstractPullBufferCaptureDevice</tt> instance from a
	 ...
	 * <tt>PullBufferDataSource</tt>. The <tt>Format</tt>-related information of the
	 * new instance is to be abstracted by a specific <tt>FormatControl</tt>.
	 *
	 * @param streamIndex   the zero-based index of the <tt>PullBufferStream</tt> in
	 ...
	 *         <tt>PullBufferDataSource</tt> and which has its
	 ...
	 * streams of this <tt>PullBufferDataSource</tt>. The <tt>PullBufferStream</tt>
	 ...
	 *
	 * @param streamIndex the zero-based index of the <tt>PullBufferStream</tt> the
	 ...
	 *         the <tt>PullBufferStream</tt> at the specified <tt>streamIndex</tt>
	 ...
	 * <tt>FormatControl</tt> as supported formats for a <tt>PullBufferStream</tt>
	 * at a specific zero-based index in the list of streams of this
	 * <tt>PullBufferDataSource</tt>.
	 *
	 * @param streamIndex the zero-based index of the <tt>PullBufferStream</tt> for
	 ...
	 *         <tt>PullBufferStream</tt> at the specified <tt>streamIndex</tt> in
	 ...
	 * zero-based index in the list of streams of this
	 * <tt>PullBufferDataSource</tt>. The <tt>PullBufferStream</tt> does not exist
	 ...
	 * creating the <tt>PullBufferStream</tt>. If setting the <tt>Format</tt> of an
	 * existing <tt>PullBufferStream</tt> is desired,
	 * <tt>AbstractPullBufferStream#doSetFormat(Format)</tt> should be overridden
	 * instead.
	 *
	 * @param streamIndex the zero-based index of the <tt>PullBufferStream</tt> the
	 ...
	 * @return the <tt>Format</tt> to be reported by the <tt>FormatControl</tt> of
	 *         the <tt>PullBufferStream</tt> at the specified <tt>streamIndex</tt>
	 *         in the list of streams of this <tt>PullBufferStream</tt> or
