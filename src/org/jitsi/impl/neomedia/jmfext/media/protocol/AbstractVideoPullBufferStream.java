...
public abstract class AbstractVideoPullBufferStream<T extends PullBufferDataSource>
	...
	/**
	 * The output frame rate of this <tt>AbstractVideoPullBufferStream</tt> which
	 * has been specified by {@link #frameRateControl} and depending on which
	 * {@link #minimumVideoFrameInterval} has been calculated.
	 */
	private float frameRate;

	/**
	 * The <tt>FrameRateControl</tt> which gets and sets the output frame rate of
	 * this <tt>AbstractVideoPullBufferStream</tt>.
	 */
	private FrameRateControl frameRateControl;

	/**
	 * The minimum interval in milliseconds between consecutive video frames i.e.
	 * the reverse of {@link #frameRate}.
	 */
	private long minimumVideoFrameInterval;

	/**
	 * Initializes a new <tt>AbstractVideoPullBufferStream</tt> instance which is to
