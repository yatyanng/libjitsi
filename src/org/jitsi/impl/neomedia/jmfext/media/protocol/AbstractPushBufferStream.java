 ...
 */
public abstract class AbstractPushBufferStream<T extends PushBufferDataSource> extends AbstractBufferStream<T>
	...
	/**
	 * Initializes a new <tt>AbstractPushBufferStream</tt> instance which is to have
	 ...
	 *                        notified by this <tt>PushBufferStream</tt> when data
