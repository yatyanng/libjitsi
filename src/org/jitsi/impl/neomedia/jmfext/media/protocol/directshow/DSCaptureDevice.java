...
public class DSCaptureDevice {
	/**
	 * The Java equivalent of the DirectShow <tt>ISampleGrabberCB</tt> interface as
	 * it is utilized by <tt>DSCaptureDevice</tt>.
	 */
	public interface ISampleGrabberCB {
		 ...
		 * @param ptr    a pointer to the captured/grabbed video frame i.e. to the data
		 *               of the DirectShow <tt>IMediaSample</tt>
	...
	/**
	 * Empty array with <tt>DSFormat</tt> element type. Explicitly defined in order
	 ...
	 *
	 * @param ptr a pointer to a native <tt>DSCaptureDevice</tt> to disconnect from
	 */
