...
public class VideoGreyFadingMediaDevice extends MediaDeviceImpl {
	...
	/**
	 * Initializes a new <tt>VideoGreyFadingMediaDevice</tt> with default framerate
	 * and dimension.
	 */
	 ...
	 * 
	 * @param dimension the dimension (width & height) of the <tt>CaptureDevice</tt>
	...
	public VideoGreyFadingMediaDevice(int framerate, Dimension dimension) {
		super(new CaptureDeviceInfo("GreyFadingVideo", new MediaLocator("greyfading:"),
				new Format[] { new RGBFormat(dimension, // size
