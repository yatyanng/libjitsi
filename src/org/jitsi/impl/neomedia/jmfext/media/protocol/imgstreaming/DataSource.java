...
public class DataSource extends AbstractVideoPullBufferCaptureDevice {
	 ...
	 * <tt>DataSource</tt> through the "standard" FMJ/JMF
	...
	private final ImgStreamingControl imgStreamingControl = new ImgStreamingControl() {
		...
		public Component getControlComponent() {
			/*
			 * This javax.media.Control implementation provides only programmatic control
			 * and not UI control.
			 */
			return null;
		}
	 ...
	 * <tt>MediaLocator</tt>.
	 *
	 * @param locator the <tt>MediaLocator</tt> to initialize the new instance from
	 */
	...
	public Object getControl(String controlType) {
		 ...
		 * getControl(String). However, overriding getControls() is much more complex
		 * and the ImgStreamingControl is too obscure. Besides, the ImgStreamingControl
		 * implementation of this DataSource does not provide UI control so it makes no
		 * sense for the caller to try to get it through getControls().
		 */
	...
	/**
	 * Set the display index and the origin of the <tt>ImageStream</tt> associated
	 * with a specific index in this <tt>DataSource</tt>.
	 *
	 * @param streamIndex  the index in this <tt>DataSource</tt> of the
	 *                     <tt>ImageStream</tt> to set the display index and the
	 *                     origin of
