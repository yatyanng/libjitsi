 ...
 */
public abstract class AbstractPullBufferStream<T extends PullBufferDataSource> extends AbstractBufferStream<T>
		implements PullBufferStream {

	/**
	 * Initializes a new <tt>AbstractPullBufferStream</tt> instance which is to have
