...
public class HResultException extends Exception {
	...
	/**
	 * Initializes a new <tt>HResultException</tt> which is to represent a specific
	 * <tt>HRESULT</tt> value. The detail message of the new instance is derived
	 * from the the specified <tt>HRESULT</tt> value.
	 *
	...
	/**
	 * Initializes a new <tt>HResultException</tt> which is to represent a specific
	 * <tt>HRESULT</tt> value and have a specific detail message.
	 *
	 * @param hresult the <tt>HRESULT</tt> value to be represented by the new
	 *                instance
