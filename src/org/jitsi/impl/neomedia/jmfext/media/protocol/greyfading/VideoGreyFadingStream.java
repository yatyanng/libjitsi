...
public class VideoGreyFadingStream extends AbstractVideoPullBufferStream<DataSource> {
	...
	/**
	 * Indicate if the video is fading toward white (if true) or toward black (if
	 * false)
	 */
	...
	/**
	 * Initializes a new <tt>VideoGreyFadingStream</tt> which is to be exposed by a
	 * specific <tt>VideoGreyFadingCaptureDevice</tt> and which is to have its
