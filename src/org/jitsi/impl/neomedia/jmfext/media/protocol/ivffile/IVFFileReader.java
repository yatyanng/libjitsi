...
public class IVFFileReader {
	...
	/**
	 * A <tt>IVFHeader</tt> representing the global header of the IVF file which
	 * this <tt>IVFFileReader</tt> will read. This header contains information like
	 * the dimension of the frame, the framerate, the number of frame. in the file,
	 * etc.
	 */
	...
	/**
	 * Initialize a new instance of <tt>IVFFileReader</tt> that will read the IVF
	 * file located by <tt>filePath</tt>.
	 * 
	 * @param filePath the location of the IVF file this <tt>IVFFileReader</tt> will
	 *                 read.
	 */
	...
	/**
	 * Get the next vp8 frame of the IVF file as a <tt>byte</tt> array. A VP8Frame
	 * is allocated for each call to this function.
	 * 
	 * @param loopFile if true and the end of the file is reached, this
	 *                 <tt>IVFFileReader</tt> will go back at the beginning of the
	 *                 file and start over the reading of the file.
	...
	/**
	 * Get the next vp8 frame of the IVF file as a <tt>byte</tt> array. You should
	 * use this function if you don't want to allocate a new VP8Frame for each call.
	 * 
	 * @param frame    the <tt>VP8Frame</tt> that will be filled with the next frame
	 *                 from the file.
	 * @param loopFile if true and the end of the file is reached, this
	 *                 <tt>IVFFileReader</tt> will go back at the beginning of the
	 *                 file and start over the reading of the file.
