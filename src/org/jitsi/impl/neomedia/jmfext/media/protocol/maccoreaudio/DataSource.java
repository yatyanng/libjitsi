...
public class DataSource extends AbstractPullBufferCaptureDevice {
	...
	/**
	 * The list of <tt>Format</tt>s in which this <tt>DataSource</tt> is capable of
	 ...
	 * which it is capable of capturing audio data overriding its registration with
	 * JMF and optionally uses audio quality improvement in accord with the
	 * preferences of the user.
	 *
	 * @param locator                 the <tt>MediaLocator</tt> to create the new
	 *                                instance from
	 * @param supportedFormats        the list of <tt>Format</tt>s in which the new
	 *                                instance is to be capable of capturing audio
	 *                                data
	 * @param audioQualityImprovement <tt>true</tt> if audio quality improvement is
	 *                                to be enabled in accord with the preferences
	 *                                of the user or <tt>false</tt> to completely
	 *                                disable audio quality improvement
	 */
	 ...
	 *         <tt>MediaLocator</tt> of this <tt>DataSource</tt>
	 * @throws IllegalStateException if there is no <tt>MediaLocator</tt> associated
	 *                               with this <tt>DataSource</tt>
	 */
	 ...
	 *
	 * @param locator the <tt>MediaLocator</tt> identifying the device index of a
	 *                MacCoreaudio device to get
	...
	public static String getDeviceID(MediaLocator locator) {
		if (locator == null) {
			/*
			 * Explicitly throw a NullPointerException because the implicit one does not
			 * have a message and is thus a bit more difficult to debug.
			 */
