...
public class RtpdumpFileReader {
	 ...
	 * 
	 * <tt>RandomAccessFile</tt> is used because I need to go to the beginning of
	 * the file when the loop is activated.
	 */
	private RandomAccessFile stream;

	/**
	 * Initialize a new instance of <tt>RtpdumpFileReader</tt> that will the rtpdump
	 ...
	 * @return a <tt>RawPacket</tt> containing all the information and data of the
	 *         next rtp packet recorded in the rtpdump file
	 * @throws IOException if <tt>loopFile</tt> was false and the end of the file is
	 *                     reached.
	 */
