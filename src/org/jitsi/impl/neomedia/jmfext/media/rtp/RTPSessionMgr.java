...
public class RTPSessionMgr extends net.sf.fmj.media.rtp.RTPSessionMgr {
	 ...
	 *
	 * @return the <tt>SSRCFactory</tt> utilized by this instance or <tt>null</tt>
	 *         if this instance employs internal logic to generate new
	 *         synchronization source (SSRC) identifiers
	 */
	...
	protected long generateSSRC(GenerateSSRCCause cause) {
		...
		return (ssrcFactory == null) ? super.generateSSRC(cause)
