...
public abstract class AbstractRenderer<T extends Format> extends ControlsAdapter implements Renderer {
	 ...
	 * <tt>Renderer</tt>.
	 *
	 * @param format the <tt>Format</tt> of the media data to be rendered by this
	 *               <tt>Renderer</tt>
	 * @return <tt>null</tt> if the specified <tt>format</tt> is not compatible with
	 *         this <tt>Renderer</tt>; otherwise, the <tt>Format</tt> which has been
	 *         successfully set
	 */
	@Override
