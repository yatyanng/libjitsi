...
/**
 * Contains the {@link MediaStreamTrackDesc}s for a {@link MediaStream}. It is
 * also part of the {@link MediaStream}'s transform chain and has the
 * opportunity to update its {@link MediaStreamTrackDesc}s with received
 * packets. This default implementation does no update the
 * {@link MediaStreamTrackDesc}s, it only serves to contain the signalled tracks
 * and encodings.
 *
...
public class MediaStreamTrackReceiver extends SinglePacketTransformerAdapter implements TransformEngine {
	...
	/**
	 * Finds the {@link RTPEncodingDesc} that matches the {@link RawPacket} passed
	 * in as a parameter. Assumes that the packet is valid.
	 *
	 * @param pkt the packet to match.
	 * @return the {@link RTPEncodingDesc} that matches the pkt passed in as a
	 *         parameter, or null if there is no matching {@link RTPEncodingDesc}.
	 */
	...
	/**
	 * Finds the {@link RTPEncodingDesc} that matches {@link ByteArrayBuffer} passed
	 * in as a parameter.
	 *
	...
	/**
	 * Gets the {@link MediaStreamTrackDesc}s that this instance is configured to
	 * receive.
	 *
	 * @return the {@link MediaStreamTrackDesc}s that this instance is configured to
	 *         receive.
	 */
	 ...
	 * {@link MediaStreamTrackDesc} instances, when one of the new instances matches
	 * (i.e. the primary SSRC of its first encoding matches) an old instance we keep
	 * the old instance. Currently we also keep the old instance's configuration
	 * (TODO use the new configuration).
	 *
	 * @param newTracks the {@link MediaStreamTrackDesc}s that this instance will
	 *                  receive. Note that the actual {@link MediaStreamTrackDesc}
	 *                  instances might not match. To get the actual instances call
	...
	/**
	 * Finds the {@link MediaStreamTrackDesc} that corresponds to the SSRC that is
