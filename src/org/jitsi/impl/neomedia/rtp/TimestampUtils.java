 ...
 * 
 * @author Ethan Lin //FIXME(brian): perhaps this should be moved alongside
 *         RTPUtils (or maybe its contents combined with RTPUtils? This class
 *         deals with RTP timestamps)
 */
public class TimestampUtils {
	// RTP timestamp is 32 bits, this represents the maximum value of an RTP
	// timestamp
	...
	/**
	 * Returns true if t1 is newer than t2, taking into account rollover. This is
	 * done by effectively checking if the distance of going from 't2' to 't1'
	 * (strictly incrementing) is shorter or if going from 't1' to 't2' (i.e.
	 * rolling over) is shorter. webrtc/modules/include/module_common_types.h
	 *
	 * @param t1
	 * @param t2
