...
public class FrameMarkingHeaderExtension {
	...
	/**
	 * The bits that need to be set in order for a packet to be considered the first
	 * packet of a keyframe.
	 */
	...
	/**
	 * @return true if the extension contained in the given buffer indicates that
	 *         the corresponding RTP packet is the first packet of a keyframe (i.e.
	...
	/**
	 * @return true if the extension contained in the given buffer indicates that
	 *         the corresponding RTP packet is the first packet of a frame (i.e. the
	 *         S bit is set).
	 */
	...
	/**
	 * @return true if the extension contained in the given buffer indicates that
	 *         the corresponding RTP packet is the last packet of a frame (i.e. the
	 *         E bit is set).
	 */
