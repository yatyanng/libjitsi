 ...
 * from webrtc.org (bitrate_controller_impl.cc, commit ID
...
public class BandwidthEstimatorImpl extends RTCPReportAdapter implements BandwidthEstimator, RecurringRunnable {
	/**
	 * The system property name of the initial value of the estimation, in bits per
	 * second.
	 */
	 ...
	 */
	private static final long START_BITRATE_BPS = cfg != null ? cfg.getLong(START_BITRATE_BPS_PNAME, 300000) : 300000;
	...
	public void rtcpReportReceived(RTCPReport report) {
		...
		synchronized (sendSideBandwidthEstimation) {
			...
			sendSideBandwidthEstimation.updateReceiverBlock(fraction_lost_aggregate, total_number_of_packets,
					lastUpdateTime);
		}
	}
