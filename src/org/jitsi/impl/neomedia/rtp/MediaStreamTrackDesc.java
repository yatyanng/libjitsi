...
public class MediaStreamTrackDesc {
	...
	/**
	 * A string which identifies the owner of this track (e.g. the endpoint which is
	 * the sender of the track).
	 */
	 ...
	 * @param rtpEncodings             The {@link RTPEncodingDesc}s that this
	 *                                 instance possesses.
	 */
	...
	/**
	 * Returns an array of all the {@link RTPEncodingDesc}s for this instance, in
	 * subjective quality ascending order.
	 *
	 * @return an array of all the {@link RTPEncodingDesc}s for this instance, in
	 *         subjective quality ascending order.
	 */
	 ...
	 * index. The "stable" bitrate is measured on every new frame and with a 5000ms
	 * window.
	 *
	...
	/**
	 * Finds the {@link FrameDesc} that corresponds to the given timestamp for the
	 * given stream (identified by its ssrc)
	 * 
	...
	/**
	 * FIXME: this should probably check whether the specified SSRC is part of this
	 * track (i.e. check all encodings and include secondary SSRCs).
	 *
	 * @param ssrc the SSRC to match.
	 * @return {@code true} if the specified {@code ssrc} is the primary SSRC for
	 *         this track.
	 */
