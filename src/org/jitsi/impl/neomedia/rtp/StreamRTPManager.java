...
public class StreamRTPManager {
	 ...
	 * forwards the RTP and RTCP flows of the <tt>MediaStream</tt> associated with
	 * this instance to other <tt>MediaStream</tt>s.
	 */
	 ...
	 * RTCP flows of the associated <tt>MediaStream</tt> to other
	 * <tt>MediaStream</tt>s.
	 *
	 * @param stream     the <tt>MediaStream</tt> that created this
	 *                   <tt>StreamRTPManager</tt>.
	 * @param translator the <tt>RTPTranslator</tt> to attach the new instance to or
	 *                   <tt>null</tt> if the new instance is to not be attached to
	 *                   any <tt>RTPTranslator</tt>
	 */
	 ...
	 *
	 * @param controlType a <tt>Class</tt> which specifies the type of the control
	 *                    over this instance to get
	 * @return a control of the specified <tt>controlType</tt> over this instance if
	 *         this instance supports such a control; otherwise, <tt>null</tt>
	 */
	 ...
	 *
	 * @param controlType a <tt>String</tt> which specifies the type (i.e. the name
	 *                    of the class) of the control over this instance to get
	 * @return a control of the specified <tt>controlType</tt> over this instance if
	 *         this instance supports such a control; otherwise, <tt>null</tt>
	 */
	 ...
	 *
	 * @param ssrcFactory the <tt>SSRCFactory</tt> to be utilized by this instance
	 *                    to generate new synchronization source (SSRC) identifiers
	 *                    or <tt>null</tt> if this instance is to employ internal
	 *                    logic to generate new synchronization source (SSRC)
	 *                    identifiers
	 */
