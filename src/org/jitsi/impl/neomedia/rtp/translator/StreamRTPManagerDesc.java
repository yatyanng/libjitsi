...
class StreamRTPManagerDesc {
	/**
	 * An array with <tt>int</tt> element type and no elements explicitly defined to
	...
	/**
	 * Initializes a new <tt>StreamRTPManagerDesc</tt> instance which is to describe
	 * a specific <tt>StreamRTPManager</tt>.
	 *
	 * @param streamRTPManager the <tt>StreamRTPManager</tt> to be described by the
	 *                         new instance
	 */
	 ...
	 *
	 * @param receiveSSRC the new SSRC to add to the list of SSRC received by the
	 ...
	 * SSRC.
	 *
	 * @param receiveSSRC the SSRC to check whether it is contained in the list of
	 *                    SSRC received by the associated <tt>StreamRTPManager</tt>
	 * @return <tt>true</tt> if the specified <tt>receiveSSRC</tt> is contained in
	 *         the list of SSRC received by the associated
