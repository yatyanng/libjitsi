...
class OutputDataStreamDesc {
	...
	/**
	 * Initializes a new <tt>OutputDataStreamDesc</tt> instance which is to describe
	 * an endpoint <tt>OutputDataStream</tt> for an <tt>RTPTranslatorImpl</tt>.
	 *
	 * @param connectorDesc the endpoint <tt>RTPConnector</tt> which owns the
	 *                      specified <tt>stream</tt>
	 * @param stream        the endpoint <tt>OutputDataStream</tt> to be described
