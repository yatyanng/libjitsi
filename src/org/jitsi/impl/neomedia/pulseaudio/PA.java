...
public final class PA {
	...
	public static native int stream_connect_playback(long s, String dev, long attr, int flags, long volume,
			long syncStream);
	 ...
	 * @return the name of the sink or source the specified <tt>pa_stream</tt> is
	 *         connected to in the server
	 */
	...
	public static native int stream_write(long s, byte[] data, int dataOffset, int dataLength, Runnable freeCb,
			long offset, int seek);
