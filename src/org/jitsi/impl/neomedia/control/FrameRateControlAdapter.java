...
public class FrameRateControlAdapter implements FrameRateControl {
	...
	/**
	 * Gets the current output frame rate. <tt>FrameRateControlAdapter</tt> always
	 * returns <tt>-1</tt>.
	 *
	 ...
	 *
	 * @return the maximum supported output frame rate if it is known; otherwise,
	 *         <tt>-1</tt>
	 ...
	 * <tt>FrameRateControlAdapter</tt> always returns <tt>-1</tt>.
	 *
	 * @return the default/preferred output frame rate if it is known; otherwise,
	 *         <tt>-1</tt>
	...
	/**
	 * Sets the output frame rate. <tt>FrameRateControlAdapter</tt> always returns
	 * <tt>-1</tt>.
	 *
	 * @param frameRate the output frame rate to change the current one to
	 * @return the actual current output frame rate or <tt>-1</tt> if it is unknown
	 *         or not controllable
