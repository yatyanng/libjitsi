...
public class ReadOnlyBufferControlDelegate implements BufferControl {
	...
	/**
	 * Initializes a new <tt>ReadOnlyBufferControlDelegate</tt> instance which is to
	 * wrap a specific <tt>BufferControl</tt> and call only its getters.
	 *
	...
	/**
	 * Implements {@link BufferControl#getEnabledThreshold()}. Gets the indicator of
	 * the wrapped <tt>BufferControl</tt> which determines whether threshold
	...
	/**
	 * Implements {@link BufferControl#setBufferLength(long)}. Ignores the request
	 * because this instance provides read-only support and returns the value
	 * actually in effect.
	 *
	 * @param bufferLength the length in milliseconds of the buffering to be
	 *                     performed by the owner of the wrapped
	 *                     <tt>BufferControl</tt>
	 * @return the length in milliseconds of the buffering performed by the owner of
	...
	/**
	 * Implements {@link BufferControl#setEnabledThreshold(boolean)}. Ignores the
	 * set request because this instance provides read-only support.
	 *
	...
	/**
	 * Implements {@link BufferControl#setMinimumThreshold(long)}. Ignores the set
	 ...
	 *                         <tt>BufferControl</tt>
	 * @return the minimum threshold in milliseconds for the buffering performed by
	 *         the owner of the wrapped <tt>BufferControl</tt> that is actually in
	 *         effect
	 */
	@Override
