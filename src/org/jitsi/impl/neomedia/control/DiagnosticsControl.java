...
public interface DiagnosticsControl extends Control {
	...
	/**
	 * Gets the time in milliseconds at which the associated procedure/process has
	 * started malfunctioning.
	 *
	 * @return the time in milliseconds at which the associated procedure/process
	 *         has started malfunctioning or <tt>NEVER</tt> if the associated
	 *         procedure/process is functioning normally
	 */
