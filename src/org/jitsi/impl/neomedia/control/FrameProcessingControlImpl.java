...
public class FrameProcessingControlImpl implements FrameProcessingControl {
	...
	public Component getControlComponent() {
		/*
		 * We totally don't care about providing a UI component which controls frame
		 * drop from inside the media implementation.
		 */
		return null;
	}

	/**
	 * Gets the number of output frames that were dropped during processing since
	 * the last call to this method.
	 *
	 * @return the number of output frame that were dropped during processing since
	 *         the last call to this method
	 */
	@Override
	...
	/**
	 * Determines whether the owner of this <tt>FrameProcessingControl</tt> is to
	 * perform only the minimum operations necessary to keep it working normally but
	 * without producing output.
	 *
	 * @return <tt>true</tt> if the owner of this <tt>FrameProcessingControl</tt> is
	 *         to perform only the minimum operations necessary to keep it working
	 *         normally but without producing output; otherwise, <tt>false</tt>
	 */
	...
	/**
	 * Sets the number of frames the owner of this <tt>FrameProcessingControl</tt>
	 * is lagging behind. It is a hint to do minimal processing for the next
	 * <tt>framesBehind</tt> frames in order to catch up.
	 *
	 ...
	 * necessary to keep it working normally but without producing output.
	 *
	 * @param minimalProcessing <tt>true</tt> if minimal processing mode is to be
	 *                          turned on or <tt>false</tt> if minimal processing
	 *                          mode is to be turned off
