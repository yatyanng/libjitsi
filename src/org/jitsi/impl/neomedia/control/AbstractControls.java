...
public abstract class AbstractControls implements Controls {
	 ...
	 * {@link #getControls()} and then looks for a control of the specified type in
	 * the returned array of controls.
	 *
	 * @param controlType a <tt>String</tt> value naming the type of the control of
	...
	/**
	 * Gets the control of a specific <tt>Controls</tt> implementation of a specific
	 * type if such a control is made available through
	 * {@link Controls#getControls()}; otherwise, returns <tt>null</tt>.
	 *
	 * @param controlsImpl the implementation of <tt>Controls</tt> which is to be
	 *                     queried for its list of controls so that the control of
	 *                     the specified type can be looked for
	...
	/**
	 * Returns an instance of a specific <tt>Class</tt> which is either a control of
	 * a specific <tt>Controls</tt> implementation or the <tt>Controls</tt>
	 * implementation itself if it is an instance of the specified <tt>Class</tt>.
	 * The method is similar to {@link #getControl(Controls, String)} in querying
	 * the specified <tt>Controls</tt> implementation about a control of the
	 * specified <tt>Class</tt> but is different in looking at the type hierarchy of
	 * the <tt>Controls</tt> implementation for the specified <tt>Class</tt>.
	 *
	 ...
	 * @return an instance of the specified <tt>controlType</tt> if such an instance
	 *         can be found among the controls of the specified
