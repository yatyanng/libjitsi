               ...
               RemoteListener
{
    ...
    public void setDevice(MediaDevice device)
    {
        ...
        if ((deviceSession == null) || (deviceSession.getDevice() != device))
        {
            ...
            {
                if (format != null) {
                	logger.debug(getClass().getName() + " " + hashCode() 
                		+ " is about to set " + format
                		+ " in "+deviceSession.getClass().getName() 
        ...
        for (ReceiveStream receiveStream : getReceiveStreams())
        {
            try
            {
                ...
                if (receiveStreamDataSource != null) {
                	logger.debug("Starting receive stream data source: "+receiveStreamDataSource.getClass().getName());
    ...
    private void stopReceiveStreams()
    {
        for (ReceiveStream receiveStream : getReceiveStreams())
        {
            try
            {
                 ...
                 */
                if (receiveStreamDataSource != null) {
                	logger.debug("Stopping receive stream data source: "+receiveStreamDataSource.getClass().getName());
