...
public class MediaStreamStats2Impl extends MediaStreamStatsImpl implements MediaStreamStats2 {
	...
	/**
	 * Notifies this instance that an RTP packet with a particular SSRC, sequence
	 * number and length was received.
	 * 
	...
	/**
	 * Notifies this instance that an RTP packet with a given SSRC and a given
	 * length was not retransmitted (that is, the remote endpoint requested it, and
	 * it was found in the local cache, but it was not retransmitted).
	 * 
	 * @param ssrc   the SSRC of the packet.
	 * @param length the length in bytes of the packet.
	 */
	 ...
	 * packet with a given SSRC, and it was not found in the local cache.
	 * 
	...
	/**
	 * Notifies this instance that an RTP packet with a particular SSRC, sequence
	 * number and length was sent (or is about to be sent).
	 * 
	 * @param ssrc   the SSRC of the packet.
	 * @param seq    the RTP sequence number of the packet.
	 * @param length the length in bytes of the packet.
	...
	/**
	 * Notifies this instance that an RTCP Receiver Report packet with a particular
	 * SSRC and the given values for total number of lost packets and extended
	 * highest sequence number was received.
	 * 
	 * @param ssrc         the SSRC of the packet.
	...
	/**
	 * Notifies this instance of a new value for the RTP jitter of the stream in a
	...
	/**
	 * Notifies this instance of a new value for the round trip time measured for
	...
	/**
	 * An {@link TrackStats} implementation which aggregates values for a collection
	 * of {@link TrackStats} instances.
	 */
	private abstract class AggregateTrackStats<T> extends AbstractTrackStats {
		/**
		 * The collection of {@link TrackStats} for which this instance aggregates.
		 */
		 ...
		 *
		 * @param interval the interval in milliseconds over which average values will
		 *                 be calculated.
	...
	/**
	 * An {@link SendTrackStats} implementation which aggregates values for a
	 * collection of {@link SendTrackStats} instances.
	 */
	private class AggregateSendTrackStats extends AggregateTrackStats<SendTrackStats> implements SendTrackStats {
		/**
		 * Initializes a new {@link AggregateTrackStats} instance.
		 *
		 * @param interval the interval in milliseconds over which average values will
	...
	/**
	 * An {@link ReceiveTrackStats} implementation which aggregates values for a
	 * collection of {@link ReceiveTrackStats} instances.
	 */
