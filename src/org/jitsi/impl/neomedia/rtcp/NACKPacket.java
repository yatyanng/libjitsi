...
/**
 * A class which represents an RTCP Generic NACK feedback message, as defined in
...
public class NACKPacket extends RTCPFBPacket {
	...
	/**
	 * @return the set of sequence numbers reported lost in the FCI field of a NACK
	 *         packet represented by a {@link ByteArrayBuffer}.
	 * @param fciBuffer the {@link ByteArrayBuffer} which represents the FCI field
	 *                  of a NACK packet.
	 */
	...
	/**
	 * Initializes a new <tt>NACKPacket</tt> instance with specific "packet sender
	 * SSRC" and "media source SSRC" values and which describes a specific set of
	 * sequence numbers.
	 * 
	 ...
	 * @param lostPackets the set of RTP sequence numbers which this NACK packet is
	 *                    to describe.
	 *
	 *                    Note that this implementation is not optimized and might
	 *                    not always use the minimal possible number of bytes to
	 *                    describe a given set of packets. Specifically, it does not
	 *                    take into account that sequence numbers wrap at 2^16 and
	 *                    fails to pack numbers close to 2^16 with those close to 0.
	 */
	...
	public String toString() {
		return "RTCP NACK packet; packet sender: " + senderSSRC + "; media sources: " + sourceSSRC + "; NACK entries: "
				+ (fci == null ? "none" : (fci.length / 4)) + "; lost packets: "
