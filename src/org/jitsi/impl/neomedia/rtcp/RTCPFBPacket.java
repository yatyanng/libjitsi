...
public class RTCPFBPacket extends RTCPPacket {
	 ...
	 * {@link ByteArrayBuffer} that is passed in the first argument is an RTCP RTPFB
	 * or PSFB packet.
	 *
	 ...
	 *         passed in the first argument is an RTCP RTPFB or PSFB packet,
	 *         otherwise false.
	 */
	 ...
	 * @return true if the packet specified in the {@link ByteArrayBuffer} passed in
	 *         as an argument is an RTP FB packet, otherwise false.
	 */
