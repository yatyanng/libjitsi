...
public class VideoTranslatorMediaDevice extends AbstractMediaDevice implements MediaDeviceWrapper, VideoListener {
	/**
	 * The <tt>MediaDevice</tt> which this instance enables to be used in a video
	 * conference implemented with an RTP translator.
	 */
	 ...
	 * <tt>outputDataSource</tt> of {@link #device} as their <tt>captureDevice</tt>.
	 */
	 ...
	 * specific <tt>MediaDevice</tt> to be used in video conferencing implemented
	 * with an RTP translator.
	 *
	 * @param device the <tt>MediaDevice</tt> which the new instance is to enable to
	 *               be used in video conferencing implemented with an RTP
	 *               translator
	 */
	 ...
	 *
	 * @param streamDeviceSession the <tt>MediaStreamMediaDeviceSession</tt> which
	 *                            has been closed
	 */
	 ...
	 *         <tt>MediaDirection.SENDRECV</tt> if this <tt>MediaDevice</tt> can
	 ...
	 * when capturing data.
	 *
	 * @return the <tt>MediaFormat</tt> that this device is currently set to provide
	 *         media in.
	 ...
	 *
	 * @param localPreset  the preset used to set the send format parameters, used
	 *                     for video and settings
	 ...
	 *
	 * @param localPreset           the preset used to set the send format
	 *                              parameters, used for video and settings
	 * @param remotePreset          the preset used to set the receive format
	 *                              parameters, used for video and settings
	 ...
	 * <tt>MediaStreamMediaDeviceSession</tt> instances. The event is expected to
	 * come from <tt>this.deviceSession</tt>, since <tt>this</tt> is registered
	 * there as a <tt>VideoListener</tt>.
	 */
	@Override
	...
	private class MediaStreamMediaDeviceSession extends VideoMediaDeviceSession {
		 ...
		 * RTCP feedback and adds the instance to RTCPFeedbackCreateListners of
		 * deviceSession.
		 *
		 ...
		 * {@inheritDoc}
		 *
		 * Creates, if necessary, the local visual <tt>Component</tt> depicting the
		 * video being streamed from the local peer to a remote peer. The
		 * <tt>Component</tt> is provided by the single <tt>Player</tt> instance, which
		 * is maintained for this <tt>VideoTranslatorMediaDevice</tt> and is managed by
		 * <tt>this.deviceSession</tt>.
		 */
		@Override
		 ...
		 * <tt>VideoTranslatorMediaDevice</tt>, and it is managed by
		 * <tt>this.deviceSession</tt>.
		 */
		@Override
