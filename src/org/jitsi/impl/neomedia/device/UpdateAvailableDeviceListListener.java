...
public interface UpdateAvailableDeviceListListener extends EventListener {
	/**
	 * Notifies this listener that the associated <tt>DeviceSystem</tt>'s function
	 * to update the list of available devices was invoked.
	 *
	...
	/**
	 * Notifies this listener that the associated <tt>DeviceSystem</tt>'s function
	 * to update the list of available devices will be invoked.
	 *
	 * @throws Exception if this implementation encounters an error. Any
	 *                   <tt>Throwable</tt> apart from <tt>ThreadDeath</tt> will be
	 *                   ignored after it is logged for debugging purposes.
