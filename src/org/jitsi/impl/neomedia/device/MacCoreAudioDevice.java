...
public class MacCoreAudioDevice extends CoreAudioDevice {
	/**
	 * The number of milliseconds to be read from or written to a native CoreAudio
	 ...
	 * MacCoreaudio streams with which they are to be opened if no other specific
	 * sample rate is specified to the MacCoreaudio <tt>DataSource</tt> or
	 * <tt>MacCoreaudioRenderer</tt> that they represent.
	 */
	...
	public static native float getNominalSampleRate(String deviceUID, boolean isOutputStream, boolean isEchoCancel);

	public static native float getMinimalNominalSampleRate(String deviceUID, boolean isOutputStream,
			boolean isEchoCancel);

	public static native float getMaximalNominalSampleRate(String deviceUID, boolean isOutputStream,
			boolean isEchoCancel);
	...
	public static native long startStream(String deviceUID, Object callback, float sampleRate, int nbChannels,
			int bitsPerChannel, boolean isFloat, boolean isBigEndian, boolean isNonInterleaved, boolean isInput,
			boolean isEchoCancel);
