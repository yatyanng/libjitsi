    ...
    implements MediaDeviceWrapper
{
    ...
    public synchronized MediaDeviceSession createSession()
    {
        ...
        logger.info(getClass().getName() + " " + hashCode() + " returns "
        		+ session.getClass().getName() + " " + session.hashCode());
        ...
        implements PropertyChangeListener
    {
        ...
        protected String getName() {
        	return getClass().getName() + " " + hashCode() 
        		+ " which contains " 
        		+ audioMixerMediaDeviceSession.getClass().getName() 
        		+ " " + audioMixerMediaDeviceSession.hashCode() ;
        }
