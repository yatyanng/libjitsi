...
public class MacCoreaudioSystem extends AudioSystem2 {
	...
	/**
	 * Gets a sample rate supported by a MacCoreaudio device with a specific device
	 * index with which it is to be registered with JMF.
	 *
	 * @param input        <tt>true</tt> if the supported sample rate is to be
	 *                     retrieved for the MacCoreaudio device with the specified
	 ...
	 *
	 * @return a sample rate supported by the MacCoreaudio device with the specified
	 ...
	 * with input channels.
	 *
	 * @throws Exception if anything wrong happens while creating the MacCoreaudio
	 *                   capture and playback devices
	 */
	MacCoreaudioSystem() throws Exception {
		super(LOCATOR_PROTOCOL, FEATURE_NOTIFY_AND_PLAYBACK_DEVICES | FEATURE_REINITIALIZE | FEATURE_ECHO_CANCELLATION);
	}
