...
public class ScreenDeviceImpl implements ScreenDevice {
	/**
	 * An array with <tt>ScreenDevice</tt> element type which is empty. Explicitly
	 * defined to reduce allocations, garbage collection.
	 */
	...
	/**
	 * Gets the default <tt>ScreenDevice</tt>. The implementation attempts to return
	 * the <tt>ScreenDevice</tt> with the highest resolution.
	 *
