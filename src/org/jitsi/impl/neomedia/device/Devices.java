...
public abstract class Devices {
	/**
	 * The name of the <tt>ConfigurationService</tt> <tt>boolean</tt> property which
	 * indicates whether the automatic selection of USB devices must be disabled.
	...
	/**
	 * The list of device ID/names saved by the configuration service and previously
	 * saved given user preference order.
	 */
	...
	/**
	 * Gets a <tt>CapatureDeviceInfo2</tt> which is known to this instance and is
	 * identified by a specific <tt>MediaLocator</tt>.
	 *
	 * @param locator the <tt>MediaLocator</tt> of the <tt>CaptureDeviceInfo2</tt>
	 *                to be returned
	 * @return a <tt>CaptureDeviceInfo2</tt> which is known to this instance and is
	 ...
	 *
	 * @param property the name of the <tt>ConfigurationService</tt> property which
			...
			synchronized (devicePreferences) {
				if (deviceIdentifiersString != null) {
					...
					String[] deviceIdentifiers = deviceIdentifiersString
							.substring(2, deviceIdentifiersString.length() - 2).split("\", \"");
	 ...
	 *                       into which the user's preference with respect to the
	 *                       specified <tt>CaptureDeviceInfo</tt> is to be saved
