...
public class QTCaptureDecompressedVideoOutput extends QTCaptureOutput {
	...
	/**
	 * Initializes a new <tt>QTCaptureDecompressedVideoOutput</tt> which represents
	 * a new QTKit <tt>QTCaptureDecompressedVideoOutput</tt> object.
	 */
	 ...
	 *
	 * @param ptr the pointer to the QTKit <tt>QTCaptureDecompressedVideoOutput</tt>
	 ...
	 *         video frames. It is equivalent to the inverse of the maximum frame
	 *         rate. The value of <tt>0</tt> indicates an unlimited maximum frame
	 *         rate.
	 */
	 ...
	 * <tt>QTCaptureDecompressedVideoOutput</tt> instance will output consecutive
	 * video frames.
	 *
	 ...
	 *         maximum frame rate. The value of <tt>0</tt> indicates an unlimited
	 *         maximum frame rate.
	 */
	 ...
	 *                                  <tt>QTCaptureDecompressedVideoOutput</tt> is
	 *                                  to output consecutive video frames. It is
	 *                                  equivalent to the inverse of the maximum
	 *                                  frame rate. The value of <tt>0</tt>
	 ...
	 * <tt>QTCaptureDecompressedVideoOutput</tt> instance is to output consecutive
	 * video frames.
	 *
	 * @param ptr                       a pointer to the
	 *                                  <tt>QTCaptureDecompressedVideoOutput</tt>
	 *                                  instance to set the minimum time interval
	 *                                  between consecutive video frame output on
	 * @param minimumVideoFrameInterval the minimum time interval between which a
	 *                                  specific
	 *                                  <tt>QTCaptureDecompressedVideoOutput</tt>
	 *                                  instance is to output consecutive video
	 *                                  frames. It is equivalent to the inverse of
	 *                                  the maximum frame rate. The value of
	 *                                  <tt>0</tt> indicates an unlimited frame
	 *                                  rate.
	 */
	private static native void setMinimumVideoFrameInterval(long ptr, double minimumVideoFrameInterval);
	...
	private static class MutableCVPixelBuffer extends CVPixelBuffer {
		/**
		 * Initializes a new <tt>MutableCVPixelBuffer</tt> which is to represent a
		 * specific CoreVideo <tt>CVPixelBufferRef</tt>.
		 *
		 * @param ptr the CoreVideo <tt>CVPixelBufferRef</tt> to be represented by the
		 *            new instance
		 */
		 ...
		 *
		 * @param ptr the CoreVideo <tt>CVImageBufferRef</tt> to be represented by this
		 *            instance
	...
	private static class MutableQTSampleBuffer extends QTSampleBuffer {
		 ...
		 *
		 * @param ptr the pointer to the QTKit <tt>QTSampleBuffer</tt> object to be
