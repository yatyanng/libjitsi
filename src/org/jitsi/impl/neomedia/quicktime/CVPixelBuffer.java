...
public class CVPixelBuffer extends CVImageBuffer {
	 ...
	 * CoreVideo <tt>CVPixelBufferRef</tt>.
	 *
	 * @return a <tt>byte</tt> array which represents the pixels of the associated
	 *         CoreVideo <tt>CVPixelBufferRef</tt>
	 */
	 ...
	 * @return a <tt>byte</tt> array which represents the pixels of the specified
	 *         CoreVideo <tt>CVPixelBufferRef</tt>
	 */
	 ...
	 * <tt>CVPixelBufferRef</tt> into a specific native byte buffer with a specific
	 * capacity.
	 *
	 ...
	 *
	 * @param ptr the CoreVideo <tt>CVPixelBufferRef</tt> to get the width in pixels
	 *            of
