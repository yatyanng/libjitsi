...
public class QTCaptureDevice extends NSObject {
	...
	/**
	 * The cached <tt>QTCaptureDevice</tt> instances previously returned by the last
	 * call to {@link #inputDevicesWithMediaType(QTMediaType)}.
	 */
	...
	/**
	 * The constant which represents an empty array with <tt>QTCaptureDevice</tt>
	...
	/**
	 * Initializes a new <tt>QTCaptureDevice</tt> instance which is to represent a
	 * specific QTKit <tt>QTCaptureDevice</tt> object.
	 *
	 * @param ptr the pointer to the QTKit <tt>QTCaptureDevice</tt> object which is
	...
	/**
	 * Releases application control over this device acquired in the {@link #open()}
	 * method.
	 */
	public void close() {
		close(getPtr());
	...
	/**
	 * Releases application control over a specific QTKit <tt>QTCaptureDevice</tt>
	 * object acquired in the {@link #open(long)} method.
	 *
	 * @param ptr the pointer to the QTKit <tt>QTCaptureDevice</tt> object to close
	 */
	 ...
	 *
	 * @param deviceUID the unique identifier of the <tt>QTCaptureDevice</tt> to be
	 *                  retrieved
	 * @return the <tt>QTCaptureDevice</tt> with the specified unique identifier if
	 *         such a <tt>QTCaptureDevice</tt> exists; otherwise, <tt>null</tt>
	 */
	...
	/**
	 * Gets the indicator which determines whether this <tt>QTCaptureDevice</tt> is
	 * connected and available to applications.
	 *
	 ...
	 * <tt>QTCaptureDevice</tt> object is connected and available to applications.
	 *
	 * @param ptr the pointer to the QTKit <tt>QTCaptureDevice</tt> object which is
	 *            to get the indicator for
	 * @return <tt>true</tt> if the specified QTKit <tt>QTCaptureDevice</tt> object
	 *         is connected and available to applications; otherwise, <tt>false</tt>
	 */
	 ...
	 *
	 * @param ptr the pointer to the QTKit <tt>QTCaptureDevice</tt> object to get
	 *            the localized human-readable name of
	...
	/**
	 * Attempts to give the application control over this <tt>QTCaptureDevice</tt>
	 * so that it can be used for capture.
	 *
	 ...
	 *                          carries an <tt>NSError</tt> describing why this
	 ...
	 *                          carries an <tt>NSError</tt> describing why the
	 *                          device could not be opened
	 */
	 ...
	 * @return the unique identifier of the specified QTKit <tt>QTCaptureDevice</tt>
	 *         object
	 */
