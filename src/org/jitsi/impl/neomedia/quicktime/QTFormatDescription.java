...
public class QTFormatDescription extends NSObject {
	...
	/**
	 * Initializes a new <tt>QTFormatDescription</tt> instance which is to represent
	 * a specific QTKit <tt>QTFormatDescription</tt> object.
	 *
	 * @param ptr the pointer to the QTKit <tt>QTFormatDescription</tt> object which
