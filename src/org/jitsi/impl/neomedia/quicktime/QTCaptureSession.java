...
public class QTCaptureSession extends NSObject {
	...
	/**
	 * Initializes a new <tt>QTCaptureSession</tt> instance which represents a new
	 * QTKit <tt>QTCaptureSession</tt> object.
	 */
	...
	/**
	 * Initializes a new <tt>QTCaptureSession</tt> instance which is to represent a
	 * specific QTKit <tt>QTCaptureSession</tt> object.
	 *
	 * @param ptr the pointer to the QTKit <tt>QTCaptureSession</tt> object to be
	...
	private static native boolean addInput(long ptr, long inputPtr) throws NSErrorException;

	public boolean addOutput(QTCaptureOutput output) throws NSErrorException {
		return addOutput(getPtr(), output.getPtr());
	}

	private static native boolean addOutput(long ptr, long outputPtr) throws NSErrorException;
