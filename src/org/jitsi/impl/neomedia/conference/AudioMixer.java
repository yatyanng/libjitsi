...
public class AudioMixer
{
    ...
    public AudioMixer(CaptureDevice captureDevice)
    {
        ...
        {
        	logger.debug("Creating a traceable capture device by using "
            ...
            AudioMixingPushBufferDataSource outDataSource)
    {
        ...
        logger.trace(
                "Adding input DataSource with hashCode "
                    + inDataSource.hashCode() +" to AudioMixer "+this.hashCode());
        ...
        synchronized (inDataSources)
        {
            ...
            addedInDataSourceDesc = new InDataSourceDesc(
                        inDataSource,
                        outDataSource);
