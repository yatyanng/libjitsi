...
class InStreamDesc {
	...
	/**
	 * The <tt>DataSource</tt> which created the <tt>SourceStream</tt> described by
	 * this instance and additional information about it.
	 */
	public final InDataSourceDesc inDataSourceDesc;

	/**
	 * The <tt>SourceStream</tt> for which additional information is described by
	 * this instance.
	 */
	 ...
	 * additional information about a specific input audio <tt>SourceStream</tt> of
	 * an <tt>AudioMixer</tt>. Associates the specified <tt>SourceStream</tt> with
	 * the <tt>DataSource</tt> which created it and additional information about it.
	 *
	 ...
	 *                         <tt>SourceStream</tt> to be described by the new
	 ...
	 *
	 * @param create the indicator which determines whether the <tt>Buffer</tt> is
	 ...
	 * contribution of the <tt>SourceStream</tt> described by this instance is to
	 * not be included.
	 *
	 ...
	 *
	 * @param inStream the <tt>SourceStream</tt> to be described by this instance
	 */
	public void setInStream(SourceStream inStream) {
		if (this.inStream != inStream) {
			...
			/*
			 * Since the inStream has changed, one may argue that the Buffer of the old
			 * value is not optimal for the new value.
			 */
			setBuffer(null);
		}
	}
