...
public class JNIDecoder extends AbstractCodec {
	...
	public synchronized void open() throws ResourceUnavailableException {
		...
		/*
		 * from ffmpeg -formats output: "For example, the h263 decoder corresponds to
		 * the h263 and h263p encoders". That's why we use CODEC_ID_H263 for the decoder
		 * side (instead of CODEC_ID_H263P).
		 */
	...
	/**
	 * Decodes H.263+ media data read from a specific input <tt>Buffer</tt> into a
