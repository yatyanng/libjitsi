...
public class JNIEncoder extends AbstractCodec {
	/**
	 * The frame rate to be assumed by <tt>JNIEncoder</tt> instance in the absence
	...
	private Format[] getMatchingOutputFormats(Format in) {
		...
		return new VideoFormat[] { new VideoFormat(Constants.H263P, videoIn.getSize(), Format.NOT_SPECIFIED,
	...
	public synchronized int process(Buffer inBuffer, Buffer outBuffer) {
		...
		/*
		 * Do not always allocate a new data array for outBuffer, try to reuse the
		 * existing one if it is suitable.
		 */
