...
/**
 * A depacketizer from VP9. See
 * {@link "https://tools.ietf.org/html/draft-ietf-payload-vp9-02"}
 *
...
public class DePacketizer {
	...
	/**
	 * A class that represents the VP9 Payload Descriptor structure defined in
	 * {@link "https://tools.ietf.org/html/draft-ietf-payload-vp9-02"}
	 */
	public static class VP9PayloadDescriptor {
		 ...
		 *
		 * @return <tt>true</tt> if the B bit from the first byte of the payload
		 *         descriptor has value 0, false otherwise.
		 */
		 ...
		 * @param len the length of the VP9 payload.
		 *
		 * @return <tt>true</tt> if the E bit from the first byte of the payload
		 *         descriptor has value 0, false otherwise.
		 */
