...
public class FFmpegAudioEncoder extends AbstractFFmpegAudioCodec {
	 ...
	 * @throws RuntimeException if no encoder with the specified <tt>codecID</tt> is
	 *                          found by FFmpeg
	 */
	...
	/**
	 * The audio data which was given to this <tt>AbstractFFmpegAudioCodec</tt> in a
	 * previous call to {@link #doProcess(Buffer, Buffer)} but was less than
	 * {@link #frameSizeInBytes} in length and was thus left to be prepended to the
	 * audio data in a next call to <tt>doProcess</tt>.
	 */
	private byte[] prevIn;
