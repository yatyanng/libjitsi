...
public class JNIDecoderImpl extends AbstractCodec2 {
	...
	static final Format[] SUPPORTED_OUTPUT_FORMATS = new Format[] { new AudioFormat(AudioFormat.LINEAR, 16000, 16, 1,
	...
	protected int doProcess(Buffer inputBuffer, Buffer outputBuffer) {
		...
		JNIDecoder.g722_decoder_process(decoder, input, inputBuffer.getOffset(), output, outputOffset, outputLength);

		outputBuffer.setDuration((outputLength * 1000000L) / (16L /* kHz */ * 2L /* sampleSizeInBits / 8 */));
