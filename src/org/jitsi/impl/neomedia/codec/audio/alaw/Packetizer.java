...
public class Packetizer extends com.ibm.media.codec.audio.AudioPacketizer {
	 ...
	 */
	public Packetizer() {
		defaultOutputFormats = new AudioFormat[] { new AudioFormat(Constants.ALAW_RTP, Format.NOT_SPECIFIED, 8, 1,
				Format.NOT_SPECIFIED, Format.NOT_SPECIFIED, 8, Format.NOT_SPECIFIED, Format.byteArray) };
		packetSize = 160;
		PLUGIN_NAME = "A-law Packetizer";
		supportedInputFormats = new AudioFormat[] { new AudioFormat(AudioFormat.ALAW, Format.NOT_SPECIFIED, 8, 1,
				Format.NOT_SPECIFIED, Format.NOT_SPECIFIED, 8, Format.NOT_SPECIFIED, Format.byteArray) };
	}
	...
	protected Format[] getMatchingOutputFormats(Format in) {
		...
		supportedOutputFormats = new AudioFormat[] { new AudioFormat(Constants.ALAW_RTP, sampleRate, 8, 1,
				Format.NOT_SPECIFIED, Format.NOT_SPECIFIED, 8, sampleRate, Format.byteArray) };
