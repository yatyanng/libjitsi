...
class DecLag3 {
	...
	/*
	 * File : DEC_LAG3.C Used for the floating point version of both G.729 main body
	 * and G.729A
	 */

	/**
	 * Decoding of fractional pitch lag with 1/3 resolution. See the source for more
	 * details about the encoding procedure.
	 *
