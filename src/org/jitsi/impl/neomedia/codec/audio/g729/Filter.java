...
class Filter {
	...
	/*
	 * File : FILTER.C Used for the floating point version of both G.729 main body
	 * and G.729A
	 */
	 ...
	 */
	static void syn_filt(float a[], int a_offset, float x[], int x_offset, float y[], int y_offset, int l, float mem[],
			int mem_offset, int update) {
	 ...
	 * @param y        output: output signal y[0:l-1]. NOTE: x[] and y[] cannot
	 *                 point to same array
