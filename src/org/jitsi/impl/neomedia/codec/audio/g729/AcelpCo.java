...
class AcelpCo {
	...
	/*
	 * File : ACELP_CO.C Used for the floating point version of G.729 main body (not
	 * for G.729A)
	 */
	 ...
	 */
	int ACELP_codebook(float x[], float h[], int t0, float pitch_sharp, int i_subfr, float code[], float y[],
			IntReference sign) {
	...
	private int d4i40_17(float dn[], float rr[], float h[], float cod[], float y[], IntReference signs, int i_subfr) {
		...
		/*
		 * The code length is 40, containing 4 nonzero pulses i0, i1, i2, i3. with pulse
		 * spacings of step = 5 Each pulses can have 8 possible positions (positive or
		 * negative):
		 *
		 * i0 (+-1) : 0, 5, 10, 15, 20, 25, 30, 35 i1 (+-1) : 1, 6, 11, 16, 21, 26, 31,
		 * 36 i2 (+-1) : 2, 7, 12, 17, 22, 27, 32, 37 i3 (+-1) : 3, 8, 13, 18, 23, 28,
		 * 33, 38 4, 9, 14, 19, 24, 29, 34, 39
		 * ---------------------------------------------------------------------------
		 */
