...
class Lspgetq {
	...
	/*
	 * File : LSPGETQ.C Used for the floating point version of both G.729 main body
	 * and G.729A
	 */
	 ...
	 */
	static void lsp_get_quant(float lspcb1[][/* M */], float lspcb2[][/* M */], int code0, int code1, int code2,
			float fg[][/* M */], float freq_prev[][/* M */], float lspq[], float fg_sum[]) {
	 ...
	 */
	private static void lsp_prev_compose(float lsp_ele[], float lsp[], float fg[][/* M */], float freq_prev[][/* M */],
			float fg_sum[]) {
		int M = Ld8k.M;
	 ...
	 */
	static void lsp_prev_extract(float lsp[/* M */], float lsp_ele[/* M */], float fg[/* MA_NP */][/* M */],
