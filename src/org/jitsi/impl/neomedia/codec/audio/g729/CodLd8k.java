...
class CodLd8k extends Ld8k {
	...
	/*
	 * File : COD_LD8K.C Used for the floating point version of G.729 main body (not
	 * for G.729A)
	 */
	...
	private final float[/* M */] lsp_old = { 0.9595f, 0.8413f, 0.6549f, 0.4154f, 0.1423f, -0.1423f, -0.4154f, -0.6549f,
			-0.8413f, -0.9595f };
	...
	/**
	 * Initialization of variables for the encoder. Initialize pointers to speech
	 * vector.
	 * 
	 * <pre>
	 *   |--------------------|-------------|-------------|------------|
	...
	void coder_ld8k(int ana[]) {
		...
		for (i_subfr = 0; i_subfr < L_FRAME; i_subfr += L_SUBFR) {
			...
			Filter.residu(Aq, Aq_offset, speech, speech_offset + i_subfr, exc, exc_offset + i_subfr,
			...
			t0 = Pitch.pitch_fr3(exc, exc_offset + i_subfr, xn, h1, L_SUBFR, t0_min.value, t0_max.value, i_subfr,
					t0_frac);
