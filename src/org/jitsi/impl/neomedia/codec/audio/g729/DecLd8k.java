...
class DecLd8k extends Ld8k {
	...
	/*
	 * File : DEC_LD8K.C Used for the floating point version of G.729 main body (not
	 * for G.729A)
	 */
	...
	int decod_ld8k(int parm[], int voicing, float synth[], int synth_offset, float A_t[]) {
		...
		for (i_subfr = 0; i_subfr < L_FRAME; i_subfr += L_SUBFR) {
			...
			Filter.syn_filt(Az, Az_offset, exc, exc_offset + i_subfr, synth, synth_offset + i_subfr, L_SUBFR, mem_syn,
					0, 1);
