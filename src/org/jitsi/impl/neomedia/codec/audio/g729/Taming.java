...
class Taming {
	...
	/*
	 * File : TAMING.C Used for the floating point version of both G.729 main body
	 * and G.729A
	 */
	...
	/**
	 * Maintains the memory used to compute the error function due to an adaptive
	 * codebook mismatch between encoder and decoder
	 *
