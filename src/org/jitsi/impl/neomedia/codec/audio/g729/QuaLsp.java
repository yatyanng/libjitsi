...
class QuaLsp {
	...
	/*
	 * File : QUA_LSP.C Used for the floating point version of both G.729 main body
	 * and G.729A
	 */
	 ...
	 */
	private static final float[/* M */] FREQ_PREV_RESET = { 0.285599f, 0.571199f, 0.856798f, 1.142397f, 1.427997f,
			1.713596f, 1.999195f, 2.284795f, 2.570394f, 2.855993f }; /* PI*(float)(j+1)/(float)(M+1) */
	 ...
	 */
	private void relspwed(float lsp[], float wegt[], float lspq[], float lspcb1[][/* M */], float lspcb2[][/* M */],
			float fg[/* MODE */][/* MA_NP */][/* M */], float freq_prev[/* MA_NP */][/* M */],
			float fg_sum[/* MODE */][/* M */], float fg_sum_inv[/* MODE */][/* M */], int code_ana[]) {
		...
		Lspgetq.lsp_get_quant(lspcb1, lspcb2, cand[mode_index], tindex1[mode_index], tindex2[mode_index],
