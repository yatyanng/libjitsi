...
public class JavaDecoder extends AbstractCodec2 {
	...
	public JavaDecoder() {
		super("G.729 Decoder", AudioFormat.class,
				new AudioFormat[] { new AudioFormat(AudioFormat.LINEAR, 8000, 16, 1, AudioFormat.LITTLE_ENDIAN,
						AudioFormat.SIGNED, /* frameSizeInBits */ Format.NOT_SPECIFIED,
						/* frameRate */ Format.NOT_SPECIFIED, Format.byteArray) });

		inputFormats = new AudioFormat[] { new AudioFormat(AudioFormat.G729_RTP, 8000, Format.NOT_SPECIFIED, 1) };
	}
	...
	protected int doProcess(Buffer inBuffer, Buffer outBuffer) {
		...
		/*
		 * Decode as many G.729 frames as possible in one go in order to mitigate an
		 * issue with sample rate conversion which leads to audio glitches.
		 */
