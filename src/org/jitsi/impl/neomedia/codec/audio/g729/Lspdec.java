...
class Lspdec {
	...
	/*
	 * File : LSPDEC.C Used for the floating point version of both G.729 main body
	 * and G.729A
	 */
	...
	private void lsp_iqua_cs(int prm[], int prm_offset, float lsp_q[], int erase) {
		...
		if (erase == 0) /* Not frame erasure */
		{
			...
			Lspgetq.lsp_get_quant(lspcb1, lspcb2, code0, code1, code2, fg[mode_index], freq_prev, lsp_q,
					fg_sum[mode_index]);
