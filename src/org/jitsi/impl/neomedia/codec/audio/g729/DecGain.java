...
class DecGain {
	 ...
	 */
	/*
	 * File : DEC_GAIN.C Used for the floating point version of both G.729 main body
	 * and G.729A
	 */
	 ...
	 */
	void dec_gain(int index, float code[], int l_subfr, int bfi, FloatReference gain_pit, FloatReference gain_code) {
