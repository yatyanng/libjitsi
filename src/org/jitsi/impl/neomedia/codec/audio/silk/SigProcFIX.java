...
import static org.jitsi.impl.neomedia.codec.audio.silk.Macros.SKP_Silk_CLZ16;
...
public class SigProcFIX extends SigProcFIXConstants {
	/**
	 * Rotate a32 right by 'rot' bits. Negative rot values result in rotating left.
	 * Output is 32bit int.
	 *
	 * @param a32
	 * @param rot
	...
	static short SKP_LSHIFT_SAT16(short a, int shift) {
		return SKP_LSHIFT16(SKP_LIMIT_16(a, (short) (Short.MIN_VALUE >> shift), (short) (Short.MAX_VALUE >> shift)),
				shift);
	}
	...
	/**
	 * (((a) > 0) ? (a) : -(a)) Be careful, SKP_abs returns wrong when input equals
	 * to SKP_intXX_MIN
	 * 
	 * @param a
	 * @return
	 ...
	 * next call (also in between frames), otherwise result won't be random at all.
	 * When only using some of the bits, take the most significant bits by
