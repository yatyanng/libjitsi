...
import static org.jitsi.impl.neomedia.codec.audio.silk.Define.LTP_BUF_LENGTH;
...
class SKP_Silk_NLSF_CB_FLP {
	...
	public SKP_Silk_NLSF_CB_FLP(int nStages, SKP_Silk_NLSF_CBS_FLP[] CBStages, float[] NDeltaMin, int[] CDF,
			int[][] StartPtr, int[] MiddleIx) {
...
//    SKP_Silk_encoder_state              sCmn;                       /* Common struct, shared with fixed-point code */
	...
	SKP_Silk_nsq_state sNSQ_LBRR = new SKP_Silk_nsq_state(); /*
																 * Noise Shape Quantizer State ( for low bitrate
																 * redundancy )
																 */
...
//    );
	...
	void NoiseShapingQuantizer(SKP_Silk_encoder_state psEnc, SKP_Silk_encoder_control psEncCtrl, SKP_Silk_nsq_state NSQ,
			final short[] x, byte[] q, final int arg6, final short[] arg7, final short[] arg8, final short[] arg9,
			final int[] arg10, final int[] arg11, final int[] arg12, final int[] arg13, int arg14, final int arg15) {
		noiseShapingQuantizerCB.NoiseShapingQuantizer(psEnc, psEncCtrl, NSQ, x, q, arg6, arg7, arg8, arg9, arg10, arg11,
