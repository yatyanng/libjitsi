...
import static org.jitsi.impl.neomedia.codec.audio.silk.Define.MAX_DELTA_GAIN_QUANT;
import static org.jitsi.impl.neomedia.codec.audio.silk.Define.MAX_QGAIN_DB;
import static org.jitsi.impl.neomedia.codec.audio.silk.Define.MIN_DELTA_GAIN_QUANT;
import static org.jitsi.impl.neomedia.codec.audio.silk.Define.MIN_QGAIN_DB;
...
public class GainQuant {
	...
	static void SKP_Silk_gains_quant(int ind[], /* O gain indices */
		...
		for (k = 0; k < NB_SUBFR; k++) {
			...
			gain_Q16[k] = Log2lin.SKP_Silk_log2lin(
					Math.min(SKP_SMULWB(INV_SCALE_Q16, prev_ind[0]) + OFFSET, 3967)); /* 3967 = 31 in Q7 */
		}
	}
