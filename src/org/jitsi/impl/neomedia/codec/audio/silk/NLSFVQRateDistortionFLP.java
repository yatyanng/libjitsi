...
public class NLSFVQRateDistortionFLP {
	...
	static void SKP_Silk_NLSF_VQ_rate_distortion_FLP(float[] pRD, /*
		...
		/*
		 * Compute weighted quantization errors for all input vectors over one codebook
		 * stage
		 */
		NLSFVQSumErrorFLP.SKP_Silk_NLSF_VQ_sum_error_FLP(pRD, in, w, psNLSF_CBS_FLP.CB, N, psNLSF_CBS_FLP.nVectors,
				LPC_order);
