...
//TODO:how to set all fields of S to 0?
		...
		if (ResamplerStructs.RESAMPLER_SUPPORT_ABOVE_48KHZ) {
			...
			if (S.nPreDownsamplers + S.nPostUpsamplers > 0) {
				...
				/*
				 * Convert sampling rate to those after pre-downsampling and before
				 * post-upsampling
				 */
		...
		if ((S.batchSize * 100 != Fs_Hz_in) || (Fs_Hz_in % 100 != 0)) {
			/*
			 * No integer number of input or output samples with 10 ms frames, use greatest
			 * common divisor
			 */
	...
	/**
	 * Clear the states of all resampling filters, without resetting sampling rate
	 * ratio.
	 * 
	 * @param S Resampler state.
	 * @return
