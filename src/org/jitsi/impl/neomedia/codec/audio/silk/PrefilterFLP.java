...
import static org.jitsi.impl.neomedia.codec.audio.silk.Define.LTP_MASK;
...
//            AR1_shp_offset = k * SHAPE_LPC_ORDER_MAX;
			...
			LPCAnalysisFilterFLP.SKP_Silk_LPC_analysis_filter_FLP(st_res, AR1_shp, px,
					px_offset - psEnc.sCmn.shapingLPCOrder, psEnc.sCmn.subfr_length + psEnc.sCmn.shapingLPCOrder,
			...
			B[1] = -psEncCtrl.GainsPre[k] * (psEncCtrl.HarmBoost[k] * HarmShapeGain + PerceptualParametersFLP.INPUT_TILT
			...
			SKP_Silk_prefilt_FLP(P, pxw, pxw_offset, pxw, pxw_offset, HarmShapeFIR, Tilt, LF_MA_shp, LF_AR_shp, lag,
