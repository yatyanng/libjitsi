...
public class LTPScaleCtrlFLP {
	 ...
	 */
	static final float LTPScaleThresholds[] = { 0.95f, 0.8f, 0.50f, 0.400f, 0.3f, 0.2f, 0.15f, 0.1f, 0.08f, 0.075f,
			0.0f };
	...
	static void SKP_Silk_LTP_scale_ctrl_FLP(SKP_Silk_encoder_state_FLP psEnc, /* I/O Encoder state FLP */
		...
		// g_HP(n) = g(n) - g(n-1) + 0.5 * g_HP(n-1); // tune the 0.5: higher means
		// longer impact of jump
