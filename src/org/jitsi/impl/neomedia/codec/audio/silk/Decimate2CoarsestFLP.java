...
public class Decimate2CoarsestFLP {
	...
	static void SKP_Silk_decimate2_coarsest_FLP(float[] in, /* I: 16 kHz signal [2*len] */
		...
		/* allpass filters */
		AllpassIntFLP.SKP_Silk_allpass_int_FLP(scratch, scratch_offset, S, S_offset, A21cst_FLP[0], scratch,
				scratch_offset + 2 * len, len);
		AllpassIntFLP.SKP_Silk_allpass_int_FLP(scratch, scratch_offset + len, S, S_offset + 1, A20cst_FLP[0], scratch,
				scratch_offset, len);
