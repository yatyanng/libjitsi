...
public class ApplySineWindowFLP {
	/**
	 * Apply sine window to signal vector. Window types: 0 -> sine window from 0 to
	 * pi. 1 -> sine window from 0 to pi/2. 2 -> sine window from pi/2 to pi.
	 *
...
//TODO float or double
	static void SKP_Silk_apply_sine_window_FLP(float px_win[], /* O Pointer to windowed signal */
