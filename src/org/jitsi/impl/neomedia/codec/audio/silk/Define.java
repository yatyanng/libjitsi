...
public class Define {
	...
	static int NLSF_MSVQ_TREE_SEARCH_MAX_VECTORS_EVALUATED_LC_MODE() {
		if (NLSF_MSVQ_MAX_VECTORS_IN_STAGE > (MAX_NLSF_MSVQ_SURVIVORS_LC_MODE
	...
	static final int TRANSITION_TIME_UP_MS = 5120; // 5120 = 64 * FRAME_LENGTH_MS * ( TRANSITION_INT_NUM - 1 ) =
													// 64*(20*4)
	static final int TRANSITION_TIME_DOWN_MS = 2560; // 2560 = 32 * FRAME_LENGTH_MS * ( TRANSITION_INT_NUM - 1 ) =
														// 32*(20*4)
