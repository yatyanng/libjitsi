...
import static org.jitsi.impl.neomedia.codec.audio.silk.Define.FIND_PITCH_LPC_WIN_MAX;
...
public class FindPitchLagsFLP {
	 ...
	 */
	static void SKP_Silk_find_pitch_lags_FLP(SKP_Silk_encoder_state_FLP psEnc, /* I/O Encoder state FLP */
...
//            x_buf_ptr = x_buf + buf_len - psPredSt->pitch_LPC_win_length;
		...
		Wsig_ptr = Wsig;
		Wsig_ptr_offset = 0;
		ApplySineWindowFLP.SKP_Silk_apply_sine_window_FLP(Wsig_ptr, Wsig_ptr_offset, x_buf_ptr, x_buf_ptr_offset, 1,
				psEnc.sCmn.la_pitch);
...
//            SKP_memcpy( Wsig_ptr, x_buf_ptr, ( psPredSt->pitch_LPC_win_length - ( psEnc->sCmn.la_pitch << 1 ) ) * sizeof( SKP_float ) );
		...
		ApplySineWindowFLP.SKP_Silk_apply_sine_window_FLP(Wsig_ptr, Wsig_ptr_offset, x_buf_ptr, x_buf_ptr_offset, 2,
				psEnc.sCmn.la_pitch);

		/* Calculate autocorrelation sequence */
		AutocorrelationFLP.SKP_Silk_autocorrelation_FLP(auto_corr, 0, Wsig, 0, psPredSt.pitch_LPC_win_length,
...
//            SKP_memset( res, 0, psEnc->sCmn.pitchEstimationLPCOrder * sizeof( SKP_float ) );
		...
		psEncCtrl.sCmn.sigtype = PitchAnalysisCoreFLP.SKP_Silk_pitch_analysis_core_FLP(res, psEncCtrl.sCmn.pitchL,
				lagIndex_djinnaddress, contourIndex_djinnaddress, LTPCorr_djinnaddress, psEnc.sCmn.prevLag,
				psEnc.pitchEstimationThreshold, thrhld, psEnc.sCmn.fs_kHz, psEnc.sCmn.pitchEstimationComplexity);
