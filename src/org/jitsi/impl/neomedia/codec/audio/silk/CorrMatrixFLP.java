...
public class CorrMatrixFLP {
	 ...
	 */
	static void SKP_Silk_corrVector_FLP(final float[] x, /* I x vector [L+order-1] used to create X */
	 ...
	 */
	static void SKP_Silk_corrMatrix_FLP(final float[] x, /* I x vector [ L+order-1 ] used to create X */
