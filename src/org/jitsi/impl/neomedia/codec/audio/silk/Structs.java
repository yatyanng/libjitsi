...
import static org.jitsi.impl.neomedia.codec.audio.silk.Define.DEC_HP_ORDER;
...
import static org.jitsi.impl.neomedia.codec.audio.silk.Define.NB_SOS;
...
class SKP_Silk_NLSF_CB_struct {
	public SKP_Silk_NLSF_CB_struct(int nStates, SKP_Silk_NLSF_CBS[] CBStages, int[] NDeltaMin_Q15, int[] CDF,
...
class SKP_Silk_encoder_state {
	...
	SKP_Silk_range_coder_state sRC_LBRR = new SKP_Silk_range_coder_state(); /*
																			 * Range coder state (for low bitrate
																			 * redundancy)
																			 */
	...
	SKP_Silk_NLSF_CB_struct[] psNLSF_CB = new SKP_Silk_NLSF_CB_struct[2]; /*
																			 * Pointers to voiced/unvoiced NLSF
																			 * codebooks
																			 */
