...
import static org.jitsi.impl.neomedia.codec.audio.silk.Define.RANGE_CODER_CDF_OUT_OF_RANGE;
import static org.jitsi.impl.neomedia.codec.audio.silk.Define.RANGE_CODER_DECODER_CHECK_FAILED;
import static org.jitsi.impl.neomedia.codec.audio.silk.Define.RANGE_CODER_DEC_PAYLOAD_TOO_LONG;
import static org.jitsi.impl.neomedia.codec.audio.silk.Define.RANGE_CODER_NORMALIZATION_FAILED;
import static org.jitsi.impl.neomedia.codec.audio.silk.Define.RANGE_CODER_WRITE_BEYOND_BUFFER;
import static org.jitsi.impl.neomedia.codec.audio.silk.Define.RANGE_CODER_ZERO_INTERVAL_WIDTH;
import static org.jitsi.impl.neomedia.codec.audio.silk.Macros.SKP_Silk_CLZ32;
...
public class RangeCoder {
	 ...
	 */
	static void SKP_Silk_range_encoder(SKP_Silk_range_coder_state psRC, /* I/O compressor data structure */
...
//            base_Q32 = base_Q32 << 8;
	 ...
	 */
	static void SKP_Silk_range_encoder_multi(SKP_Silk_range_coder_state psRC, /* I/O compressor data structure */
...
//TODO:                if( ( base_Q32 >> 16 ) != 0 ) {
	 ...
	 * @param psRC compressor data structure.
	 */
	static void SKP_Silk_range_enc_init(SKP_Silk_range_coder_state psRC /* O compressor data structure */
	) {
	 ...
	 */
	static void SKP_Silk_range_dec_init(SKP_Silk_range_coder_state psRC, /* O compressor data structure */
		...
		psRC.bufferIx = 0;
		psRC.base_Q32 = (((buffer[buffer_offset + 0] & 0xFF) << 24) | ((buffer[buffer_offset + 1] & 0xFF) << 16)
	 ...
	 */
	static void SKP_Silk_range_enc_wrap_up(SKP_Silk_range_coder_state psRC /* I/O compressed data structure */
	) {
