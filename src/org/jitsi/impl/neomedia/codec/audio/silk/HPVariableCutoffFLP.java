...
public class HPVariableCutoffFLP {
	 ...
	 */
	static void SKP_Silk_HP_variable_cutoff_FLP(SKP_Silk_encoder_state_FLP psEnc, /* I/O Encoder state FLP */
		...
		if (psEnc.sCmn.prev_sigtype == SIG_TYPE_VOICED) {
			...
			delta_freq = SigProcFLP.SKP_LIMIT_float(delta_freq, -DefineFLP.VARIABLE_HP_MAX_DELTA_FREQ,
...
///*TEST END****************************************************************************/
		...
		BiquadAlt.SKP_Silk_biquad_alt(in, in_offset, B_Q28, A_Q28, psEnc.sCmn.In_HP_State, out, out_offset,
