...
//        min_rate_dist = SKP_float_MAX;
		...
		for (k = 0; k < 3; k++) {
			...
			for (j = 0; j < NB_SUBFR; j++) {
				...
				VQNearestNeighborFLP.SKP_Silk_VQ_WMat_EC_FLP(temp_idx, /* O index of best codebook vector */
...
//                LTP_ORDER );
			SigProcFLP.SKP_short2float_array(B, j * LTP_ORDER, cbk_ptr_Q14, cbk_index[j] * LTP_ORDER, LTP_ORDER);
		}
