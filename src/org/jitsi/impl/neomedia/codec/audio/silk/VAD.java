...
import static org.jitsi.impl.neomedia.codec.audio.silk.Define.VAD_INTERNAL_SUBFRAMES;
import static org.jitsi.impl.neomedia.codec.audio.silk.Define.VAD_INTERNAL_SUBFRAMES_LOG2;
import static org.jitsi.impl.neomedia.codec.audio.silk.Define.VAD_NEGATIVE_OFFSET_Q5;
import static org.jitsi.impl.neomedia.codec.audio.silk.Define.VAD_NOISE_LEVELS_BIAS;
import static org.jitsi.impl.neomedia.codec.audio.silk.Define.VAD_NOISE_LEVEL_SMOOTH_COEF_Q16;
import static org.jitsi.impl.neomedia.codec.audio.silk.Define.VAD_N_BANDS;
import static org.jitsi.impl.neomedia.codec.audio.silk.Define.VAD_SNR_FACTOR_Q16;
import static org.jitsi.impl.neomedia.codec.audio.silk.Define.VAD_SNR_SMOOTH_COEF_Q18;
...
import static org.jitsi.impl.neomedia.codec.audio.silk.Typedef.SKP_uint8_MAX;
...
//      SKP_memset( psSilk_VAD, 0, sizeof( SKP_Silk_VAD_state ) );
	...
	static int SKP_Silk_VAD_GetSA_Q8( /* O Return value, 0 if success */
		...
		AnaFiltBank1.SKP_Silk_ana_filt_bank_1(pIn, pIn_offset, psSilk_VAD.AnaState, 0, X[0], 0, X[3], 0, scratch,
				framelength);

		/* 0-4 kHz to 0-2 kHz and 2-4 kHz */
		AnaFiltBank1.SKP_Silk_ana_filt_bank_1(X[0], 0, psSilk_VAD.AnaState1, 0, X[0], 0, X[2], 0, scratch,
				framelength >> 1);

		/* 0-2 kHz to 0-1 kHz and 1-2 kHz */
		AnaFiltBank1.SKP_Silk_ana_filt_bank_1(X[0], 0, psSilk_VAD.AnaState2, 0, X[0], 0, X[1], 0, scratch,
				framelength >> 2);
		...
		for (b = 0; b < VAD_N_BANDS; b++) {
			/*
			 * Accumulate signal-without-noise energies, higher frequency bands have more
			 * weight
			 */
