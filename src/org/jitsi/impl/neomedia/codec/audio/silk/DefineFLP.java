...
public class DefineFLP {
	...
	/*
	 * Regualarization factor for correlation matrix. Equivalent to adding noise at
	 * -50 dB
	 */
	...
	/*
	 * Max absolute difference between log2 of pitch frequency and smoother state,
	 * to enter the smoother
	 */
