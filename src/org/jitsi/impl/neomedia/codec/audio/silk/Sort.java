...
public class Sort {
	 ...
	 */
	static void SKP_Silk_insertion_sort_increasing(int[] a, /* I/O: Unsorted / Sorted vector */
	 ...
	 * @param K     Number of correctly sorted positions
	 */
	static void SKP_Silk_insertion_sort_decreasing(int[] a, /* I/O: Unsorted / Sorted vector */
			int[] index, /* O: Index vector for the sorted elements */
			final int L, /* I: Vector length */
			final int K /* I: Number of correctly sorted positions */
	) {
	 ...
	 * @param K     Number of correctly sorted positions
	 */
	static void SKP_Silk_insertion_sort_decreasing_int16(short[] a, /* I/O: Unsorted / Sorted vector */
			int[] index, /* O: Index vector for the sorted elements */
			final int L, /* I: Vector length */
			final int K /* I: Number of correctly sorted positions */
	) {
	 ...
	 * @param L        Vector length
	 */
	static void SKP_Silk_insertion_sort_increasing_all_values(int[] a, /* I/O: Unsorted / Sorted vector */
	 ...
	 * @param K     Number of correctly sorted positions
	 */
	static void SKP_Silk_shell_insertion_sort_increasing(int[] a, /* I/O: Unsorted / Sorted vector */
			int[] index, /* O: Index vector for the sorted elements */
			final int L, /* I: Vector length */
			final int K /* I: Number of correctly sorted positions */
	) {
...
//            inc = SKP_RSHIFT_ROUND( inc_Q16_tmp, 16 );
	 ...
	 * @param L     Vector length.
	 */
	static void SKP_Silk_shell_sort_increasing_all_values(int[] a, /* I/O: Unsorted / Sorted vector */
			int[] index, /* O: Index vector for the sorted elements */
			final int L /* I: Vector length */
	) {
		int value, inc_Q16_tmp;
