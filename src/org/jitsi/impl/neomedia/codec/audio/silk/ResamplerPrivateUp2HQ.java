...
public class ResamplerPrivateUp2HQ {
	/**
	 * Upsample by a factor 2, high quality. Uses 2nd order allpass filters for the
	 * 2x upsampling, followed by a notch filter just above Nyquist.
	 * 
	...
	static void SKP_Silk_resampler_private_up2_HQ(int[] S, /* I/O: Resampler state [ 6 ] */
		...
		for (k = 0; k < len; k++) {
			...
			out[out_offset + 2 * k] = (short) SigProcFIX
					.SKP_SAT16(SKP_SMLAWB(256, out32_1, ResamplerRom.SKP_Silk_resampler_up2_hq_notch[3]) >> 9);
