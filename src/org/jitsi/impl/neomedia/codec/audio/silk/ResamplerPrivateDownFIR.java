		...
		while (true) {
			...
			if (S.FIR_Fracs == 1) {
				for (index_Q16 = 0; index_Q16 < max_index_Q16; index_Q16 += index_increment_Q16) {
					...
					res_Q6 = SKP_SMLAWB(res_Q6, buf_ptr[buf_ptr_offset + 1] + buf_ptr[buf_ptr_offset + 10],
							FIR_Coefs[FIR_Coefs_offset + 1]);
					res_Q6 = SKP_SMLAWB(res_Q6, buf_ptr[buf_ptr_offset + 2] + buf_ptr[buf_ptr_offset + 9],
							FIR_Coefs[FIR_Coefs_offset + 2]);
					res_Q6 = SKP_SMLAWB(res_Q6, buf_ptr[buf_ptr_offset + 3] + buf_ptr[buf_ptr_offset + 8],
							FIR_Coefs[FIR_Coefs_offset + 3]);
					res_Q6 = SKP_SMLAWB(res_Q6, buf_ptr[buf_ptr_offset + 4] + buf_ptr[buf_ptr_offset + 7],
							FIR_Coefs[FIR_Coefs_offset + 4]);
					res_Q6 = SKP_SMLAWB(res_Q6, buf_ptr[buf_ptr_offset + 5] + buf_ptr[buf_ptr_offset + 6],
...
//BugFix                    interpol_ptr_offset = ResamplerRom.RESAMPLER_DOWN_ORDER_FIR / 2 * ( S.FIR_Fracs - 1 - interpol_ind );
					interpol_ptr_offset = FIR_Coefs_offset
							+ ResamplerRom.RESAMPLER_DOWN_ORDER_FIR / 2 * (S.FIR_Fracs - 1 - interpol_ind);
