...
public class AnaFiltBank1 {
	...
	private static final short[] A_fb1_21 = {
			(short) (20623 << 1) }; /* wrap-around to negative number is intentional */
	...
	static void SKP_Silk_ana_filt_bank_1(short[] in, /* I: Input signal [N] */
			...
			int outH_offset, int[] scratch, /* I: Scratch memory [3*N/2] */ // todo: remove - no longer used
