...
import static org.jitsi.impl.neomedia.codec.audio.silk.Define.CONCEC_SWB_SMPLS_THRES;
import static org.jitsi.impl.neomedia.codec.audio.silk.Define.HP_8_KHZ_THRES;
...
import static org.jitsi.impl.neomedia.codec.audio.silk.Define.WB_DETECT_ACTIVE_SPEECH_MS_THRES;
...
public class DetectSWBInput {
	 ...
	 */
	static void SKP_Silk_detect_SWB_input(SKP_Silk_detect_SWB_state psSWBdetect, /* (I/O) encoder state */
		...
		Biquad.SKP_Silk_biquad(samplesIn, samplesIn_offset, TablesOther.SKP_Silk_SWB_detect_B_HP_Q13[0],
				TablesOther.SKP_Silk_SWB_detect_A_HP_Q13[0], psSWBdetect.S_HP_8_kHz[0], in_HP_8_kHz, 0, HP_8_kHz_len);
		for (i = 1; i < NB_SOS; i++) {
			Biquad.SKP_Silk_biquad(in_HP_8_kHz, 0, TablesOther.SKP_Silk_SWB_detect_B_HP_Q13[i],
					TablesOther.SKP_Silk_SWB_detect_A_HP_Q13[i], psSWBdetect.S_HP_8_kHz[i], in_HP_8_kHz, 0,
					HP_8_kHz_len);
		}
		...
		/*
		 * Count concecutive samples above threshold, after adjusting threshold for
		 * number of input samples and shift
		 */
