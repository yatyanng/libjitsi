...
import static org.jitsi.impl.neomedia.codec.audio.silk.Macros.SKP_SMLAWW;
...
public class Inlines extends InlinesConstants {
	...
	/**
	 * returns the number of left shifts before overflow for a 16 bit number (ITU
	 * definition with norm(0)=0).
	 * 
	 * @param a
	 * @return
	 */
	...
	/**
	 * returns the number of left shifts before overflow for a 32 bit number (ITU
	 * definition with norm(0)=0)
	 * 
	 * @param a
	 * @return
	...
	/**
	 * Sine approximation; an input of 65536 corresponds to 2 * pi Uses polynomial
	 * expansion of the input to the power 0, 2, 4 and 6 The relative error is below
	 * 1e-5
	 *
	 * @param x
	...
	/**
	 * Cosine approximation; an input of 65536 corresponds to 2 * pi The relative
	 * error is below 1e-5
	 * 
	 * @param x
