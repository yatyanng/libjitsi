 ...
 */
public class RewritablePullBufferDataSource extends PullBufferDataSourceDelegate<PullBufferDataSource>
	...
	/**
	 * Initializes a new <tt>RewritablePullBufferDataSource</tt> instance which is
	 * to provide mute support for a specific <tt>PullBufferDataSource</tt>.
	 *
	...
	/**
	 * Implements {@link PullBufferDataSource#getStreams()}. Wraps the streams of
	 * the wrapped <tt>PullBufferDataSource</tt> into <tt>MutePullBufferStream</tt>
	...
	/**
	 * Implements a <tt>PullBufferStream</tt> wrapper which provides mute support
	...
	private class MutePullBufferStream extends SourceStreamDelegate<PullBufferStream> implements PullBufferStream {
		...
		/**
		 * Initializes a new <tt>MutePullBufferStream</tt> instance which is to provide
		 * mute support for a specific <tt>PullBufferStream</tt>.
		 *
		 * @param stream the <tt>PullBufferStream</tt> the new instance is to provide
		 *               mute support for
		 */
		...
		/**
		 * Implements PullBufferStream#read(Buffer). If this instance is muted (through
		 * its owning RewritablePullBufferDataSource), overwrites the data read from the
		 * wrapped PullBufferStream with silence data.
		 * 
		 * @param buffer which data will be filled. @throws IOException Thrown if an
