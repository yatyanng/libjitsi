...
public abstract class BufferStreamAdapter<T extends SourceStream> implements SourceStream {
	 ...
	 * <tt>SourceStream</tt> into a <tt>SourceStream</tt> with a specific
	 * <tt>Format</tt>.
	 *
	...
	/**
	 * Reads byte data from this stream into a specific <tt>Buffer</tt> which is to
	 * use a specific array of bytes for its data.
	 *
	 * @param buffer the <tt>Buffer</tt> to read byte data into from this instance
	 ...
	 *               <tt>flags</tt>
	 * @param data   the array of <tt>byte</tt>s into which the data read from this
	 *               stream is to be written
	 * @param offset the offset in the specified <tt>data</tt> at which writing data
	 *               read from this stream should start
	 * @param length the maximum number of bytes to be written into the specified
	 *               <tt>data</tt>
