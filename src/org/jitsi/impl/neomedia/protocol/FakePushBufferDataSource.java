...
public class FakePushBufferDataSource extends AbstractPushBufferCaptureDevice {
	...
	/**
	 * Initializes a new <tt>FakePushBufferCaptureDevice</tt> instance which is to
	 * report a specific list of <tt>Format</tt>s as supported.
	 *
	...
	public void connect() throws IOException {
		/*
		 * The connect, disconnect, start and stop methods of the super have been
		 * overridden in order to disable consistency checks with respect to the
		 * connected and started states.
		 */
	}
	...
	private static class FakePushBufferStream extends AbstractPushBufferStream<FakePushBufferDataSource> {
		 ...
		 * <tt>FormatControl</tt>.
		 *
		 * @param dataSource    the <tt>FakePushBufferDataSource</tt> which is creating
		 ...
		 * {@inheritDoc}
		 *
		 * Allows setting an arbitrary format on this <tt>SourceStream</tt> because it
		 * does not really provide any media.
		 */
		@Override
		...
		public void read(Buffer buffer) throws IOException {
			/*
			 * The whole point of FakePushBufferDataSource and FakePushBufferStream is that
			 * this read method is a no-op (and this FakePushBufferStream will never invoke
			 * its associated transferHandler).
			 */
		}
	}
}
