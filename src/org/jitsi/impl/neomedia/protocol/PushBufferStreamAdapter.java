...
public class PushBufferStreamAdapter extends BufferStreamAdapter<PushSourceStream> implements PushBufferStream {
	...
	/**
	 * Initializes a new <tt>PushBufferStreamAdapter</tt> instance which reads its
	 * data from a specific <tt>PushSourceStream</tt> with a specific
	 * <tt>Format</tt>
	 *
	 * @param stream the <tt>PushSourceStream</tt> the new instance is to read its
	 *               data from
