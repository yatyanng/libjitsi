...
public abstract class PullBufferDataSourceDelegate<T extends DataSource>
	...
	/**
	 * Initializes a new <tt>PullBufferDataSourceDelegate</tt> which is to delegate
	 ...
	 * <tt>DataSource</tt>. Overrides
	 * {@link CaptureDeviceDelegatePullBufferDataSource#disconnect()} because the
	 * wrapped <tt>DataSource</tt> may not be a <tt>CaptureDevice</tt> yet it still
	 ...
	 * <tt>DataSource</tt>. Overrides
	 * {@link CaptureDeviceDelegatePullBufferDataSource#getContentType()} because
	 ...
	 * <tt>DataSource</tt>. Overrides
	 * {@link CaptureDeviceDelegatePullBufferDataSource#getControl(String)} because
	 * the wrapped <tt>DataSource</tt> may not be a <tt>CaptureDevice</tt> yet it
	 ...
	 * {@link CaptureDeviceDelegatePullBufferDataSource#getControls()} because the
	 * wrapped <tt>DataSource</tt> may not be a <tt>CaptureDevice</tt> yet it still
	 ...
	 * <tt>DataSource</tt>. Overrides
	 * {@link CaptureDeviceDelegatePullBufferDataSource#getDuration()} because the
	 * wrapped <tt>DataSource</tt> may not be a <tt>CaptureDevice</tt> yet it still
	 ...
	 * <tt>DataSource</tt>. Overrides
	 * {@link CaptureDeviceDelegatePullBufferDataSource#start()} because the wrapped
	 ...
	 * <tt>DataSource</tt>. Overrides
	 * {@link CaptureDeviceDelegatePullBufferDataSource#stop()} because the wrapped
	 * <tt>DataSource</tt> may not be a <tt>CaptureDevice</tt> yet it still needs to
	 * be stopped.
	 *
	 * @throws IOException if the wrapped <tt>DataSource</tt> throws such an
