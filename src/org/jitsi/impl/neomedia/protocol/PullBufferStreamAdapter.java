...
public class PullBufferStreamAdapter extends BufferStreamAdapter<PullSourceStream> implements PullBufferStream {
	...
	/**
	 * Initializes a new <tt>PullBufferStreamAdapter</tt> instance which reads its
	 * data from a specific <tt>PullSourceStream</tt> with a specific
	 * <tt>Format</tt>
	 *
	 * @param stream the <tt>PullSourceStream</tt> the new instance is to read its
	 *               data from
	 * @param format the <tt>Format</tt> of the specified input <tt>stream</tt> and
	 *               of the new instance
	 */
	 ...
	 *
	 * @param format the <tt>Format</tt> to determine the frame size in bytes of
