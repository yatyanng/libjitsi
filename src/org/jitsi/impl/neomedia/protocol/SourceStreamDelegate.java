...
public class SourceStreamDelegate<T extends SourceStream> implements SourceStream {
	...
	/**
	 * Initializes a new <tt>SourceStreamDelegate</tt> instance which is to wrap a
	 * specific <tt>SourceStream</tt>.
	 *
	 * @param stream the <tt>SourceStream</tt> the new instance is to wrap
	 */
	 ...
	 * <tt>SourceStream</tt>.
	 *
	 * @return <tt>true</tt> if the wrapped <tt>SourceStream</tt> has reached the
	 *         end the content it makes available
	 */
	@Override
	 ...
	 *         for the wrapped <tt>SourceStream</tt>
	 */
	@Override
