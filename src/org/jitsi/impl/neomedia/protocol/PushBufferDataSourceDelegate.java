...
public abstract class PushBufferDataSourceDelegate<T extends DataSource>
	...
	/**
	 * Initializes a new <tt>PushBufferDataSourceDelegate</tt> which is to delegate
	 * to a specific <tt>DataSource</tt>.
	 *
	 ...
	 * wrapped <tt>DataSource</tt> may not be a <tt>CaptureDevice</tt> yet it still
	 ...
	 * <tt>DataSource</tt>. Overrides
	 * {@link CaptureDeviceDelegatePushBufferDataSource#disconnect()} because the
	 * wrapped <tt>DataSource</tt> may not be a <tt>CaptureDevice</tt> yet it still
	 ...
	 * <tt>DataSource</tt>. Overrides
	 * {@link CaptureDeviceDelegatePushBufferDataSource#getContentType()} because
	 * the wrapped <tt>DataSource</tt> may not be a <tt>CaptureDevice</tt> yet it
	 * still needs to report the content type.
	 *
	 ...
	 * <tt>DataSource</tt>. Overrides
	 * {@link CaptureDeviceDelegatePushBufferDataSource#getControl(String)} because
	 * the wrapped <tt>DataSource</tt> may not be a <tt>CaptureDevice</tt> yet it
	 * still needs to give access to the control.
	 *
	 ...
	 * {@link CaptureDeviceDelegatePushBufferDataSource#getControls()} because the
	 * wrapped <tt>DataSource</tt> may not be a <tt>CaptureDevice</tt> yet it still
	 * needs to give access to the controls.
	 *
	 ...
	 * <tt>DataSource</tt>. Overrides
	 * {@link CaptureDeviceDelegatePushBufferDataSource#getDuration()} because the
	 * wrapped <tt>DataSource</tt> may not be a <tt>CaptureDevice</tt> yet it still
	 * needs to report the duration.
	 *
	 ...
	 * <tt>DataSource</tt>. Overrides
	 * {@link CaptureDeviceDelegatePushBufferDataSource#start()} because the wrapped
	 * <tt>DataSource</tt> may not be a <tt>CaptureDevice</tt> yet it still needs to
	 * be started.
	 *
	 * @throws IOException if the wrapped <tt>DataSource</tt> throws such an
	 *                     exception
	 ...
	 * <tt>DataSource</tt>. Overrides
	 * {@link CaptureDeviceDelegatePushBufferDataSource#stop()} because the wrapped
	 * <tt>DataSource</tt> may not be a <tt>CaptureDevice</tt> yet it still needs to
	 * be stopped.
	 *
	 * @throws IOException if the wrapped <tt>DataSource</tt> throws such an
