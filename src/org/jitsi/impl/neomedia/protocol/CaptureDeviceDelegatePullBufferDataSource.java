...
public class CaptureDeviceDelegatePullBufferDataSource extends PullBufferDataSource implements CaptureDevice {
	private static final Logger logger = Logger.getLogger(CaptureDeviceDelegatePullBufferDataSource.class);
	/**
	...
	/**
	 * The constant which represents an empty array with <tt>PullBufferStream</tt>
	...
	/**
	 * Initializes a new <tt>CaptureDeviceDelegatePullBufferDataSource</tt> instance
