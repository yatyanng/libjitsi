...
public class RTPConnectorTCPImpl extends AbstractRTPConnector {
	...
	/**
	 * Initializes a new <tt>RTPConnectorTCPImpl</tt> which is to use a given pair
	 * of sockets for RTP and RTCP traffic specified in the form of a
	 * <tt>StreamConnector</tt>.
	 *
	 * @param connector the pair of sockets for RTP and RTCP traffic the new
	 *                  instance is to use
	 */
