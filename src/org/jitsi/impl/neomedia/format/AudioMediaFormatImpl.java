...
public class AudioMediaFormatImpl extends MediaFormatImpl<AudioFormat> implements AudioMediaFormat {
	...
	/**
	 * Initializes a new <tt>AudioMediaFormatImpl</tt> instance which is to provide
	 * an implementation of <tt>AudioMediaFormat</tt> for a specific JMF
	 * <tt>AudioFormat</tt>.
	 *
	 * @param format the JMF <tt>AudioFormat</tt> the new instance is to wrap and
	 ...
	 * parameters.
	 *
	 * @param format             the JMF <tt>AudioFormat</tt> the new instance is to
	 *                           wrap and provide an implementation of
	 *                           <tt>AudioMediaFormat</tt> for
	 ...
	 *                           instance
	 */
	AudioMediaFormatImpl(AudioFormat format, Map<String, String> formatParameters,
			Map<String, String> advancedParameters) {
		super(fixChannels(format), formatParameters, advancedParameters);
	}

	/**
	 * Initializes a new <tt>AudioMediaFormatImpl</tt> instance with the specified
	 * encoding and a single audio channel.
	 *
	...
	/**
	 * Initializes a new <tt>AudioMediaFormatImpl</tt> instance with the specified
	 * encoding and clock rate and a single audio channel.
	 *
	 * @param encoding  the encoding of the new <tt>AudioMediaFormatImpl</tt>
	 *                  instance
	...
	/**
	 * Initializes a new <tt>AudioMediaFormatImpl</tt> instance with the specified
	 * encoding, clock rate and number of audio channels.
	 *
	 * @param encoding  the encoding of the new <tt>AudioMediaFormatImpl</tt>
	 *                  instance
	 * @param clockRate the clock (i.e. sample) rate of the new
	...
	/**
	 * Initializes a new <tt>AudioMediaFormatImpl</tt> instance with the specified
	 * encoding, clock rate and format parameters and a single audio channel.
	 *
	 * @param encoding           the encoding of the new
	 *                           <tt>AudioMediaFormatImpl</tt> instance
	 * @param clockRate          the clock (i.e. sample) rate of the new
	 *                           <tt>AudioMediaFormatImpl</tt> instance
	 * @param formatParameters   any codec-specific parameters that have been
	 *                           received via SIP/SDP or XMPP/Jingle.
	 * @param advancedParameters set of advanced parameters that have been received
	 *                           by SIP/SDP or XMPP/Jingle
	 */
	...
	/**
	 * Initializes a new <tt>AudioMediaFormatImpl</tt> instance with the specified
	 * encoding, clock rate, number of audio channels and format parameters.
	 *
	 * @param encoding           the encoding of the new
	 *                           <tt>AudioMediaFormatImpl</tt> instance
	 * @param clockRate          the clock (i.e. sample) rate of the new
	 ...
	 * @param formatParameters   any codec-specific parameters that have been
	 *                           received via SIP/SDP or XMPP/Jingle
	 * @param advancedParameters any parameters that have been received via SIP/SDP
	 *                           or XMPP/Jingle
	 */
	AudioMediaFormatImpl(String encoding, double clockRate, int channels, Map<String, String> formatParameters,
			Map<String, String> advancedParameters) {
		this(new AudioFormat(encoding, clockRate, Format.NOT_SPECIFIED, channels), formatParameters,
				advancedParameters);
	}

	/**
	 * Gets an <tt>AudioFormat</tt> instance which matches a specific
	 * <tt>AudioFormat</tt> and has 1 channel if the specified <tt>AudioFormat</tt>
	 * has its number of channels not specified.
	 *
	 * @param format the <tt>AudioFormat</tt> to get a match of
	 * @return if the specified <tt>format</tt> has a specific number of channels,
	 *         <tt>format</tt>; otherwise, a new <tt>AudioFormat</tt> instance which
	 *         matches <tt>format</tt> and has 1 channel
	 */
	private static AudioFormat fixChannels(AudioFormat format) {
		if (Format.NOT_SPECIFIED == format.getChannels())
			format = (AudioFormat) format.intersects(
					new AudioFormat(format.getEncoding(), format.getSampleRate(), format.getSampleSizeInBits(), 1));
		return format;
	}
	...
	/**
	 * Gets the type of this <tt>MediaFormat</tt> which is {@link MediaType#AUDIO}
