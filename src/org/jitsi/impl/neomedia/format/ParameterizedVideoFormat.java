...
public class ParameterizedVideoFormat extends VideoFormat {
	 ...
	 *                 array of <tt>String</tt>s in which the key and the value of
	 *                 an association are expressed as consecutive elements.
	 */
	...
	public Object clone() {
		ParameterizedVideoFormat f = new ParameterizedVideoFormat(getEncoding(), getSize(), getMaxDataLength(),
				...
				/*
				 * The formatParameters will be copied by ParameterizedVideoFormat#copy(Format)
				 * bellow.
				 */
				null);
	 ...
	 *
	 * @param         <T> the very type of the keys and the values to be associated
	 *                in the new <tt>Map</tt>
	 * @param entries the associations to be created in the new <tt>Map</tt> where
