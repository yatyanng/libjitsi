...
public class VideoMediaFormatImpl extends MediaFormatImpl<VideoFormat> implements VideoMediaFormat {
	...
	/**
	 * The name of the format parameter which specifies the packetization mode of
	 * H.264 RTP payload.
	 */
	...
	/**
	 * Initializes a new <tt>VideoMediaFormatImpl</tt> instance which is to provide
	 * an implementation of <tt>VideoMediaFormat</tt> for a specific JMF
	 * <tt>VideoFormat</tt>.
	 *
	 * @param format the JMF <tt>VideoFormat</tt> the new instance is to wrap and
	 ...
	 *
	 * @param format             the JMF <tt>VideoFormat</tt> the new instance is to
	 *                           wrap and provide an implementation of
	 *                           <tt>VideoMediaFormat</tt> for
	 * @param clockRate          the clock rate of the new
	 *                           <tt>VideoMediaFormatImpl</tt> instance
	 * @param frameRate          the frame rate of the new
	 *                           <tt>VideoMediaFormatImpl</tt> instance
	 ...
	 */
	VideoMediaFormatImpl(VideoFormat format, double clockRate, float frameRate, Map<String, String> formatParameters,
			Map<String, String> advancedParameters) {
		super(new ParameterizedVideoFormat(format.getEncoding(), format.getSize(), format.getMaxDataLength(),
				format.getDataType(), frameRate, formatParameters), formatParameters, advancedParameters);
	 ...
	 *         this instance and their other characteristics are equal;
	 ...
	 * {@inheritDoc}
	 * <p>
	 * Takes into account RFC 3984 "RTP Payload Format for H.264 Video" which says
	 * that &quot;[w]hen the value of packetization-mode [format parameter] is equal
	 * to 0 or packetization-mode is not present, the single NAL mode, as defined in
	 * section 6.2 of RFC 3984, MUST be used.&quot;
	 * </p>
	 *
	...
	/**
	 * Gets the type of this <tt>MediaFormat</tt> which is {@link MediaType#VIDEO}
	 * for <tt>AudioMediaFormatImpl</tt> instances.
	 *
	 ...
	 *
	 * @return a {@link Dimension} instance indicating the image size (in pixels) of
	 *         this <tt>VideoMediaFormat</tt>
	...
	public int hashCode() {
		 ...
		 * MediaFormatFactory#CLOCK_RATE_NOT_SPECIFIED and #DEFAULT_CLOCK_RATE are
		 * equal.
		 */
		if (MediaFormatFactory.CLOCK_RATE_NOT_SPECIFIED == clockRate)
			clockRate = DEFAULT_CLOCK_RATE;
