...
public class CircularByteArray {
	...
	/**
	 * The index at which the next invocation of {@link #push(byte)} is to insert an
	 * element.
	 */
	private int tail;
	 ...
	 * <tt>byte</tt> array.
	 *
	 * @return a new <tt>byte</tt> array which contains the same elements and in the
	 *         same order as this <tt>CircularByteArray</tt>
	 */
