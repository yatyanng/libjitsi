...
public abstract class TransformInputStream<T> extends RTPConnectorInputStream<T> {
	 ...
	 *
	 * @param socket the (network) socket from which packets are to be received and
	 *               transformed by the new instance
	 */
	 ...
	 * data through its {@link #read(byte[], int, int)} method. Reverse-transforms
	 * the received packet.
	 *
	...
	/**
	 * Sets the <tt>PacketTransformer</tt> which is to be used to reverse-transform
	 * packets. Set to <tt>null</tt> to disable transformation.
	 *
