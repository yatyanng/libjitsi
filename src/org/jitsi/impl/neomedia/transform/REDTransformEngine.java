...
public class REDTransformEngine implements TransformEngine, PacketTransformer {
	...
	/**
	 * The RED payload type for incoming packets. Only RTP packets with this payload
	 * type will be reverse-transformed by this <tt>PacketTransformer</tt>.
	 *
	 ...
	 * packets.
	 *
	 * The special value "-1" is used to effectively disable transforming packets by
	 * this <tt>PacketTransformer</tt>.
	 */
