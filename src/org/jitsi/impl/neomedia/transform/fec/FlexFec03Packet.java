...
/**
 * @author bbaldino Based on FlexFec draft -03
...
public class FlexFec03Packet extends RawPacket {
	 ...
	 * @return a {@link FlexFec03Packet} if 'p' is successfully parsed as a
	 *         {@link FlexFec03Packet}, null otherwise
	 */
	...
	public static FlexFec03Packet create(byte[] buffer, int offset, int length) {
		...
		FlexFec03Header header = FlexFec03HeaderReader.readFlexFecHeader(flexFecPacket.getBuffer(),
				flexFecPacket.getFlexFecHeaderOffset(), flexFecPacket.getLength() - flexFecPacket.getHeaderLength());
		if (header == null) {
			return null;
		}
	 ...
	 * @param offset offset at which the rtp packet starts in the given buffer
