...
public class FlexFec03HeaderReader {
	/**
	 * The minimum size of the FlexFec header, in bytes. We include here one
	 * instance of SSRC_i and SN base_i, as well as the smallest possible packet
	 * mask.
	 */
	private static int HEADER_MIN_SIZE_BYTES = 20;

	/**
	 * The offset of the mask in the flexfec header, relative to the start of the
	 * flexfec header
	 */
	 ...
	 * @param flexFecOffset the flexFecOffset in buffer at which the flexfec header
	 *                      starts
