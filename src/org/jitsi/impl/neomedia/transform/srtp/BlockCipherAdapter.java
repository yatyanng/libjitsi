...
public class BlockCipherAdapter implements BlockCipher {
	...
	/**
	 * Initializes a new <tt>BlockCipherAdapter</tt> instance which is to adapt a
	 * specific <tt>javax.crypto.Cipher</tt> instance to the
	 * <tt>org.bouncycastle.crypto.BlockCipher</tt> interface.
	 *
	...
	public BlockCipherAdapter(Cipher cipher) {
		...
		if (algorithmName != null) {
			...
			if ((len > 4) && (algorithmName.endsWith("_128") || algorithmName.endsWith("_192")
