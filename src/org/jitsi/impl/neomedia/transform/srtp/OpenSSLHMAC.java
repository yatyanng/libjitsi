...
public class OpenSSLHMAC implements Mac {
	...
	/**
	 * The key provided in the form of a {@link KeyParameter} in the last invocation
	 * of {@link #init(CipherParameters)}.
	 */
	private byte[] key;
	...
	public int doFinal(byte[] out, int outOff) throws DataLengthException, IllegalStateException {
		...
		if (outLen < macSize) {
			throw new DataLengthException(
					"Space in out must be at least " + macSize + "bytes but is " + outLen + " bytes!");
		}
	...
	public void init(CipherParameters params) throws IllegalArgumentException {
		key = (params instanceof KeyParameter) ? ((KeyParameter) params).getKey() : null;
