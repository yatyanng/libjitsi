...
public class SecurityProviderBlockCipherFactory implements BlockCipherFactory {
	 ...
	 * <tt>BlockCipher</tt>s that are implemented by a specific
	 * <tt>java.security.Provider</tt>.
	 *
	 * @param transformation the name of the transformation
	 * @param provider       the <tt>java.security.Provider</tt> which provides the
	 *                       implementations of the <tt>BlockCipher</tt>s to be
	 ...
	 *                       provides the implementations of the
	 *                       <tt>BlockCipher</tt>s to be initialized by the new
	 *                       instance
	 */
