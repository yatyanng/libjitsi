...
class BaseSRTPCryptoContext {
	...
	/**
	 * Authenticates a packet. Calculated authentication tag is returned/stored in
	 * {@link #tagStore}.
	 *
	...
	/**
	 * Closes this crypto context. The close functions deletes key data and performs
	 * a cleanup of this crypto context. Clean up key data, maybe this is the second
	 * time. However, sometimes we cannot know if the CryptoContext was used and the
	 * application called deriveSrtpKeys(...).
	 */
