...
public class SRTCPCryptoContext extends BaseSRTPCryptoContext {
	...
	/**
	 * Construct an empty SRTPCryptoContext using ssrc. The other parameters are set
	 * to default null value.
	 *
	 ...
	 *                   cryptographic context. Refer to chapter 3.2.1 of the RFC
	 *                   about the role of the master key.
	...
	/**
	 * Transform a RTP packet into a SRTP packet. The method is called when a normal
	 * RTP packet ready to be sent. Operations done by the transformation may
