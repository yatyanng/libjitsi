...
public class TransformUDPOutputStream extends RTPConnectorUDPOutputStream implements TransformOutputStream {
	/**
	 * The {@code TransformOutputStream} which aids this instance in implementing
	 * the interface in question.
	 */
	private final TransformOutputStreamImpl _impl;

	/**
	 * Initializes a new <tt>TransformOutputStream</tt> which is to send packet data
	 * out through a specific UDP socket.
	 *
