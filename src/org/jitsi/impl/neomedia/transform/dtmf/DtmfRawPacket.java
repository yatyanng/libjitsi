...
public class DtmfRawPacket extends RawPacket {
	 ...
	 * @param payload the payload that has been negotiated for telephone events by
	...
	public void init(int code, boolean end, boolean marker, int duration, long timestamp, int volume) {
		if (logger.isTraceEnabled()) {
			logger.trace("DTMF send on RTP, code : " + code + " duration = " + duration + " timestamps = " + timestamp
	 ...
	 * packets. R always = 0. Volume always = 0. Duration : duration increments for
	 * each dtmf sending updates, stay unchanged at the end for the 3 last packets.
	 * 
	 * <pre>
	 *  0                   1                   2                   3
	 ...
	 * @param duration int increments for each dtmf sending updates, stay unchanged
