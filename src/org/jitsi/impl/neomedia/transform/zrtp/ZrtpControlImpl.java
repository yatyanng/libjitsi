...
public class ZrtpControlImpl extends AbstractSrtpControl<ZRTPTransformEngine> implements ZrtpControl {
	/**
	 * Additional info codes for and data to support ZRTP4J. These could be added to
	 * the library. However they are specific for this implementation, needing them
	 * for various GUI changes.
	 */
	...
	/**
	 * Initializes a new <tt>ZRTPTransformEngine</tt> instance to be associated with
	 * and used by this <tt>ZrtpControlImpl</tt> instance.
	 *
	 * @return a new <tt>ZRTPTransformEngine</tt> instance to be associated with and
	 *         used by this <tt>ZrtpControlImpl</tt> instance
	 */
	@Override
	 ...
	 *
	 * @param connector the <tt>RTPConnector</tt> which is to use or uses this ZRTP
	 *                  engine
	 */
	@Override
	...
	/**
	 * Start multi-stream ZRTP sessions. After the ZRTP Master (DH) session reached
	 * secure state the SCCallback calls this method to start the multi-stream ZRTP
	 * sessions. Enable auto-start mode (auto-sensing) to the engine.
	 *
