...
public class TlsClientImpl extends DefaultTlsClient {
	...
	/**
	 * The <tt>SRTPProtectionProfile</tt> negotiated between this DTLS-SRTP client
	 * and its server.
	 */
	private int chosenProtectionProfile;

	/**
	 * The SRTP Master Key Identifier (MKI) used by the <tt>SRTPCryptoContext</tt>
	 * associated with this instance. Since the <tt>SRTPCryptoContext</tt> class
	 * does not utilize it, the value is {@link TlsUtils#EMPTY_BYTES}.
	 */
	 ...
	 * initialized.
	 *
	 * @return the <tt>TlsContext</tt> with which this <tt>TlsClient</tt> has been
	 *         initialized
	 */
	...
	/**
	 * Determines whether this {@code TlsClientImpl} is to operate in pure DTLS mode
	 ...
	 * {@inheritDoc}
	 *
	 * Makes sure that the DTLS extended server hello contains the <tt>use_srtp</tt>
	 * extension.
	 */
	@Override
	@SuppressWarnings("rawtypes")
	...
	private class TlsAuthenticationImpl implements TlsAuthentication {
		...
		public TlsCredentials getClientCredentials(CertificateRequest certificateRequest) throws IOException {
			if (clientCredentials == null) {
				...
				clientCredentials = new DefaultTlsSignerCredentials(context, certificateInfo.getCertificate(),
