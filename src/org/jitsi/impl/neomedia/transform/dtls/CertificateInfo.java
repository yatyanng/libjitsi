...
class CertificateInfo {
	 ...
	 * digest algorithm of the signature algorithm of {@link #certificate} in accord
	 * with RFC 4572).
	 */
	 ...
	 *
	 * @param keyPair                      the private and public keys of
	 *                                     {@code certificate}
	 * @param certificate                  the certificate with which the local
	 *                                     endpoint represented by the new instance
	 *                                     is to authenticates its ends of DTLS
	 *                                     sessions
