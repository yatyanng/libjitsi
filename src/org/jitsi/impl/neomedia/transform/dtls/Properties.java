...
class Properties extends PropertyChangeNotifier {
	...
	/**
	 * The actual {@code Map} of property names to property values represented by
	 * this instance. Stores only assignable properties i.e. {@code final}s are
	 * explicitly defined (e.g. {@link #srtpDisabled}).
	 */
	private final Map<String, Object> properties = new ConcurrentHashMap<>();

	/**
	 * Indicates whether this <tt>DtlsControl</tt> will work in DTLS/SRTP or pure
	 * DTLS mode.
	 */
	 ...
	 *
	 * @param srtpDisabled {@code true} to specify pure DTLS without SRTP extensions
	 *                     or {@code false} to specify DTLS/SRTP.
	 */
	...
	/**
	 * Indicates if SRTP extensions are disabled which means we're working in pure
	 * DTLS mode.
	 *
	...
	public void put(String name, Object value) {
		...
		// them.)
		Object oldValue = (value == null) ? properties.remove(name) : properties.put(name, value);
