...
public class RTPTransformTCPConnector extends RTPConnectorTCPImpl {
	...
	/**
	 * The customized <tt>TransformEngine</tt> which contains the concrete transform
	 * logic.
	 */
	private TransformEngine engine;

	/**
	 * Initializes a new <tt>TransformConnector</tt> which is to use a given pair of
	 * datagram sockets for RTP and RTCP traffic specified in the form of a
	...
	protected RTPConnectorTCPInputStream createControlInputStream() throws IOException {
		RTPConnectorTCPInputStream controlInputStream = new RTPConnectorTCPInputStream(getControlSocket());
	 ...
	 * transform logic.
	 *
	 * @return the <tt>TransformEngine</tt> which contains the concrete transform
	 *         logic
	 */
	 ...
	 * <tt>TransformerEngine</tt> which is used to transform and reverse-transform
	 * RTCP packets.
	 *
	 ...
	 *         <tt>TransformEngine</tt> and it specifies a <tt>TransformEngine</tt>
	 *         for RTCP data; otherwise, <tt>null</tt>
	 */
	 ...
	 *         <tt>TransformEngine</tt> and it specifies a <tt>TransformEngine</tt>
	 *         for RTP data; otherwise, <tt>null</tt>
	 */
