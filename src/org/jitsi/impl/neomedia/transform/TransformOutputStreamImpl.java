...
public class TransformOutputStreamImpl extends AbstractTransformOutputStream {
	/**
	 * The {@code OutputDataStream} this instance facilitates in the implementation
	...
	/**
	 * Initializes a new {@code TransformOutputStreamImpl} which is to facilitate a
	 * specific {@code OutputDataStream} in the implementation of the interface
	 * {@code TransformOutputStream}.
	 *
	 * @param outputDataStream the {@code OutputDataStream} the new instance is to
	 *                         facilitate in the implementation of the interface
	 *                         {@code TransformOutputStream}
	 */
