...
public class AudioLevelMap {
	 ...
	 *
	 * @return <tt>true</tt> if <tt>csrc</tt> was present in the <tt>Map</tt> and
	...
	/**
	 * Returns the audio level of the specified <tt>csrc</tt> id or <tt>-1</tt> if
	 * <tt>csrc</tt> is not currently registered in this map.
	 *
	 * @param csrc the CSRC ID whose level we'd like to obtain.
	 *
	 * @return the audio level of the specified <tt>csrc</tt> id or <tt>-1</tt> if
	 *         <tt>csrc</tt> is not currently registered in this map.
	 */
	...
	/**
	 * Returns the index of the specified <tt>csrc</tt> level in the <tt>levels</tt>
	 * matrix or <tt>-1</tt> if <tt>levels</tt> is <tt>null</tt> or does not contain
	 * <tt>csrc</tt>.
	 *
	 * @param levels the bi-dimensional array that we'd like to search for the
	...
	/**
	 * Creates a new bi-dimensional array containing all entries (if any) from the
	 * <tt>levels</tt> matrix and an extra entry for the specified <tt>csrc</tt> and
	 * <tt>level</tt>.
	 *
	 * @param levels the bi-dimensional levels array that we'd like to add a mapping
	 *               to.
	 ...
	 *
	 * @return a new matrix containing all entries from levels and a new one mapping
	 *         <tt>csrc</tt> to <tt>level</tt>
	 */
