 ...
 * based on the samples in the <tt>Buffer</tt> and includes them in the buffer's
 * <tt>headerExtension</tt> field in the SSRC audio level format specified in
 * RFC6464.
 *
...
public class AudioLevelEffect2 extends ControlsAdapter implements Effect {
	...
	/**
	 * Whether this effect is enabled or disabled. If disabled, this <tt>Effect</tt>
	 * will set the RTP header extension of the output buffer to <tt>null</tt>.
	 */
	...
	public int process(Buffer inputBuffer, Buffer outputBuffer) {
		...
		if (enabled && rtpHeaderExtensionId != -1 && data instanceof byte[]) {
			byte level = AudioLevelCalculator.calculateAudioLevel((byte[]) data, outputBuffer.getOffset(),
