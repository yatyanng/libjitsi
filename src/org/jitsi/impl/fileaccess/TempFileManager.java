...
public class TempFileManager {
	...
	/**
	 * Creates a temporary file in the proper directory to allow for cleanup after
	 ...
	 * method to create files that need to be persistent between application runs.
	 *
	 * @param prefix the prefix string used in generating the file name; must be at
	...
	/**
	 * Static block used to clean up any old temp directories found -- the JVM will
	 * run this block when a class loader loads the class.
	 */
	static {
