...
public abstract class DatabaseConfigurationStore extends HashtableConfigurationStore<Hashtable> {
	 ...
	 * <tt>ConfigurationStore</tt> instance and deserializes new property name-value
	 ...
	 * this <tt>ConfigurationStore</tt> instance into its underlying database
	 * (storage).
	 *
	 * @throws IOException if there is an output error while storing the properties
	 *                     managed by this <tt>ConfigurationStore</tt> instance into
	 *                     its underlying database (storage)
	 */
