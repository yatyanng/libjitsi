...
public class XMLConfUtils extends XMLUtils {
	 ...
	 * 
	 * @param parent the xml element that is the parent of the root of this chain.
	 * @param chain  a String array containing the names of all the child's parent
	 *               nodes.
	...
	/**
	 * Creates (only if necessary) and returns the element which is at the end of
	 * the specified path.
	 * 
	 * @param doc        the target document where the specified path should be
	 *                   created
	 * @param path       an array of <tt>String</tt> elements which represents the
	 *                   path to be created. Each element of <tt>path</tt> up to and
	 *                   including the index <code>pathLength - 1</code> must be
