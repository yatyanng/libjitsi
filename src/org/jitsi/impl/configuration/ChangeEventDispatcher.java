...
public class ChangeEventDispatcher {
	 ...
	 * vetos the change, then fire a new ConfigurationChangeEvent indicating that
	 * the change has been accepted. In the case of a PropertyVetoException, end
	 * eventdispatch and rethrow the exception
	 * <p>
	 ...
	 * the change, then the exception will be rethrown by this method.
	 * <p>
	 * No event is fired if old and new are equal and non-null.
	 *
	 * @param evt The PropertyChangeEvent to be fired.
	 * @exception PropertyVetoException if at least one of the recipients has vetoed
	 *                                  the change.
	 */
		...
		synchronized (this) {
			if (vetoableChangeListeners != null) {
				targets = vetoableChangeListeners
						.toArray(new ConfigVetoableChangeListener[vetoableChangeListeners.size()]);
			}
	...
	/**
	 * Check if there are any listeners for a specific property. (Generic listeners
	 * count as well)
	 *
