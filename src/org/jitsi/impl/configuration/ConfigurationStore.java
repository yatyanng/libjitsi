...
public interface ConfigurationStore {
	 ...
	 * property with a specific name. If the property with the specified name is not
	 * associated with a value in this <tt>ConfigurationStore</tt>, does nothing.
	 *
	...
	/**
	 * Sets a property with a specific name to be considered a system property by
	 * the <tt>ConfigurationStore</tt>.
	 *
	 ...
	 *            <tt>ConfigurationStore</tt>
	 * @throws IOException if there is an output error while storing the properties
