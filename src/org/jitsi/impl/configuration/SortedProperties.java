...
public class SortedProperties extends Properties {
	...
	/**
	 * Gets an <tt>Enumeration</tt> of the keys in this <tt>Properties</tt> object.
	 * Contrary to the original <tt>Properties</tt> implementation, it forces the
	 * keys to be alphabetically sorted.
	 *
	...
	/**
	 * Does not allow putting empty <tt>String</tt> keys in this <tt>Properties</tt>
	 * object.
	 *
	 * @param key   the key
	...
	public synchronized Object put(Object key, Object value) {
		 ...
		 * characters only (which would be trimmed) consumed megabytes of heap. Do now
		 * allow such keys.
		 */
