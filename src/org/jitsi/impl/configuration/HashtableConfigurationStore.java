...
public abstract class HashtableConfigurationStore<T extends Hashtable> implements ConfigurationStore {
	 ...
	 *
	 * @param properties the map that this store will use for storing and retrieving
	 *                   properties.
	 */
	 ...
	 * <tt>ConfigurationStore</tt> contains a value associated with the specified
	 * property name, returns it. Otherwise, searches for a system property with the
	...
	/**
	 * Implements {@link ConfigurationStore#getPropertyNames()}. Gets the names of
	 * the properties which have values associated in this
	 * <tt>ConfigurationStore</tt>.
	 *
	...
	/**
	 * Implements {@link ConfigurationStore#isSystemProperty(String)}. Considers a
	 * property to be system if the system properties contain a value associated
	 * with its name.
	 *
	 * @param name the name of a property which is to be determined whether it is a
	 *             system property
	 ...
	 *
	 * @param name the name of the property which is to have its value association
	 *             in this <tt>ConfigurationStore</tt> removed
	 ...
	 *
	 * @param name  the name of the non-system property to be set to the specified
	...
	/**
	 * Implements {@link ConfigurationStore#setSystemProperty(String)}. Since system
	 * properties are managed through the <tt>System</tt> class, setting a property
	 * as system in this <tt>ConfigurationStore</tt> effectively removes any
	 * existing value associated with the specified property name from this
	 * instance.
	 *
