...
public class PropertyConfigurationStore extends HashtableConfigurationStore<Properties> {
	...
	/**
	 * Overrides
	 * {@link HashtableConfigurationStore#setNonSystemProperty(String, Object)}. As
	 * the backend of this instance is a <tt>Properties</tt> instance, it can only
	 * store <tt>String</tt> values and the specified value to be associated with
	 * the specified property name is converted to a <tt>String</tt>.
	 *
