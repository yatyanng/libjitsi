...
public class DTMFToneEvent extends EventObject {
	...
	/**
	 * Creates an instance of this <tt>DTMFToneEvent</tt> with the specified source
	 * stream and DTMF tone.
	 *
	 * @param source   the <tt>AudioMediaSteam</tt> instance that received the tone.
