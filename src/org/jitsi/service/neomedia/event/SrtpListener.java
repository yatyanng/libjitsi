...
public interface SrtpListener {
	...
	/**
	 * Indicates that the security has been turned on. When we are in the case of
	 * using multistreams when the master stream ZRTP is initialized and established
	 * the param multiStreamData holds the data needed for the slave streams to
	 * establish their sessions. If this is a securityTurnedOn event on non master
	 * stream the multiStreamData is null.
	 *
	...
	/**
	 * Indicates that the other party has timed out replying to our offer to secure
	 * the connection.
	 *
	 * @param mediaType the <tt>MediaType</tt> of the call session
	 */
