...
public interface SimpleAudioLevelListener {
	 ...
	 * <tt>MAX_LEVEL</tt> because (1) we transport the levels within RTP and it
	 * gives us a signed <tt>byte</tt> for it, and (2) the range of
	 ...
	 * conference. Level values should be distributed among {@link #MAX_LEVEL} and
	 ...
	 * <tt>MIN_LEVEL</tt> because (1) we transport the levels within RTP and it
	 * gives us a signed <tt>byte</tt> for it, and (2) the range of
	 * <code>[0, 127]</tt> is pretty good to directly express the sound pressure
	 * level decibels as heard by humans in Earth's atmosphere.
	 * </p>
	...
	/**
	 * Indicates a new audio level for the source that this listener was registered
	 * with.
	 * 
	 * @param level the new/current level of the audio source that this listener is
	 *              registered with.
	 */
