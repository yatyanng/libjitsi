...
public class VolumeChangeEvent extends EventObject {
	 ...
	 *
	 * @param source the <tt>VolumeControl</tt> which is the source of the change
	 * @param level  the volume level
	 * @param mute   <tt>true</tt> if the volume is muted; otherwise, <tt>false</tt>
	...
	/**
	 * Gets the <tt>VolumeControl</tt> which is the source of the change notified
	 * about by this <tt>VolumeChangeEvent</tt>.
	 *
	 * @return the <tt>VolumeControl</tt> which is the source of the change notified
	 *         about by this <tt>VolumeChangeEvent</tt>
	 */
