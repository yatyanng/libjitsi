...
public interface MediaFormat {
	 ...
	 * <tt>MediaFormat</tt> instance describes a format without an RTP payload type
	 * (number) known in RFC 3551 "RTP Profile for Audio and Video Conferences with
	 * Minimal Control".
	 */
	 ...
	 * (i.e. contains no decimal point) unless it is actually a non integer.
	 *
	...
	/**
	 * Determines whether this <tt>MediaFormat</tt> is equal to <tt>mediaFormat</tt>
	 * i.e. they have the same encoding, clock rate, format parameters, advanced
	 * attributes, etc.
	 *
	...
	/**
	 * Determines whether the format parameters of this <tt>MediaFormat</tt> match a
	 * specific set of format parameters.
	 *
	 * @param fmtps the set of format parameters to match to the format parameters
	 *              of this <tt>MediaFormat</tt>
	 * @return <tt>true</tt> if this <tt>MediaFormat</tt> considers <tt>fmtps</tt>
	 *         matching its format parameters; otherwise, <tt>false</tt>
	 */
	 ...
	 * particular <tt>MediaFormat</tt>. The parameters returned here are meant for
	 ...
	 * SIP/SDP or XMPP session descriptions where they get transported through the
	 * "fmtp:" attribute or <parameter/> tag respectively.
	 *
	 ...
	 * @param channels         the number of channels that expect to find in this
	 *                         format
	 * @param formatParameters the format parameters expected to match these of the
