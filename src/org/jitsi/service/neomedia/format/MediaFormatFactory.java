...
public interface MediaFormatFactory {
	...
	/**
	 * The constant to be used as an argument representing a clock rate to denote
	 * that a specific clock rate is not specified.
	 */
	 ...
	 *                      with the specified <tt>encoding</tt>; otherwise, ignored
	 * @param formatParams  any codec specific parameters which have been received
	 *                      via SIP/SDP or XMPP/Jingle
	 * @param advancedAttrs advanced attributes received via SIP/SDP or XMPP/Jingle
	 * @return a <tt>MediaFormat</tt> with the specified <tt>encoding</tt>,
