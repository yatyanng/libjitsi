...
public interface MediaStreamStats {
	...
	/**
	 * Returns the number of packets discarded since the beginning of the session,
	 * because the packet queue was full.
	 *
	 * @return the number of packets discarded since the beginning of the session,
	 *         because the packet queue was full.
	 */
	...
	/**
	 * Returns the number of packets discarded since the beginning of the session,
	 * because the packet queue was reset.
	 *
	 * @return the number of packets discarded since the beginning of the session,
	 *         because the packet queue was reset.
	 */
	...
	/**
	 * Returns the number of packets discarded since the beginning of the session,
	 * while the packet queue was shrinking.
	 *
	 * @return the number of packets discarded since the beginning of the session,
	 *         while the packet queue was shrinking.
	 */
	...
	/**
	 * Gets the detailed statistics about the RTCP reports sent and received by the
	 * associated local peer.
	 *
	 * @return the detailed statistics about the RTCP reports sent and received by
	 ...
	 * @deprecated use the appropriate method from {@link MediaStreamStats2}
	 *             instead.
	 * @return The RTT computed with the RTCP feedback. Returns <tt>-1</tt> if the
	 *         RTT has not been computed yet. Otherwise the RTT in ms.
	 */
	@Deprecated
	long getRttMs();
	...
	/**
	 * Checks whether there is an adaptive jitter buffer enabled for at least one of
	 * the <tt>ReceiveStream</tt>s of the <tt>MediaStreamImpl</tt>.
	 *
	 * @return <tt>true</tt> if there is an adaptive jitter buffer enabled for at
	 *         least one of the <tt>ReceiveStream</tt>s of the
	...
	/**
	 * Gets the average of the RTP jitter values reported to us in RTCP reports, in
	 * milliseconds. Returns -1D if the value is unknown.
	 * 
	 * @return the average of the RTP jitter values reported to us in RTCP reports,
	...
	/**
	 * Returns the number of RTP packets sent by the remote side, but not received
	 * by us.
	 * 
	 * @deprecated use the appropriate method from {@link MediaStreamStats2}
	 *             instead.
	 * @return the number of RTP packets sent by the remote side, but not received
	 *         by us.
	 */
	@Deprecated
	...
	/**
	 * Returns the number of RTP packets sent by us, but not received by the remote
	 * side.
	 * 
	 * @deprecated use the appropriate method from {@link MediaStreamStats2}
	 *             instead.
	 * @return the number of RTP packets sent by us, but not received by the remote
	 *         side.
	 */
	@Deprecated
	...
	/**
	 * Gets the rate at which we are currently sending data to the remote endpoint
	 * in bits per second. This is almost the same as
	 * {@link #getUploadRateKiloBitPerSec()}. The duplication is necessary, because
