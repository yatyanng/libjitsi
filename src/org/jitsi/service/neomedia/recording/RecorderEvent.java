...
public class RecorderEvent {
	 ...
	 * <tt>json</tt>.
	 * 
	 * @param json a JSON object, containing fields with which to initialize the
	 *             fields of this <tt>RecorderEvent</tt>.
	 */
	...
	public enum Type {
		 ...
		 * indicates the SSRC of the audio stream which is now considered active, and
		 * the 'ssrc' field contains the SSRC of a video stream associated with the now
		 * active audio stream.
		 */
