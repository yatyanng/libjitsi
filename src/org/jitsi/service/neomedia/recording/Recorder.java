...
public interface Recorder {
	/**
	 * The name of the configuration property the value of which specifies the full
	 * path to the directory with media recorded by <tt>Recorder</tt> (e.g. the
	 ...
	 * format in which media is to be recorded by <tt>Recorder</tt> (e.g. the media
	 * being sent and received in a <tt>Call</tt>).
	 */
	...
	/**
	 * Removes an existing <tt>Listener</tt> from the list of listeners interested
	 ...
	 * @throws             org.jitsi.service.neomedia.MediaException if anything
	 *                     else goes wrong while starting the recording of media
	 *                     performed by this <tt>Recorder</tt>
	 */
	...
	public interface Listener {
		/**
		 * Notifies this <tt>Listener</tt> that a specific <tt>Recorder</tt> has stopped
		 * recording the media associated with it.
		 *
	...
	/**
	 * Sets the <tt>RecorderEventHandler</tt> which this <tt>Recorder</tt> should
	 * notify when events related to recording (such as start/end of a recording)
	 * occur.
	 * 
