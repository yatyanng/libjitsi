...
public interface Synchronizer {
	...
	/**
	 * Notifies this <tt>Synchronizer</tt> that the RTP timestamp <tt>rtpTime</tt>
	 * (for SSRC <tt>ssrc</tt>) corresponds to the NTP timestamp <tt>ntpTime</tt>.
	 * 
	 * @param ssrc    the SSRC.
	 ...
	 * <tt>System.currentTimeMillis()</tt>) that corresponds to the RTP timestamp
	 * <tt>rtpTime</tt> for the SSRC <tt>ssrc</tt>.
	 *
	 * Returns -1 if the local time cannot be found (for example because not enough
	 * information for the SSRC has been previously provided to the
	 * <tt>Synchronizer</tt>).
	 *
