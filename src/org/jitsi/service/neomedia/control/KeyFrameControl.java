...
public interface KeyFrameControl {
	 ...
	 *
	 * @param index             the zero-based index at which
	 *                          <tt>keyFrameRequestee</tt> is to be added to the
	 *                          list of <tt>KeyFrameRequestee</tt>s made available
	 *                          or <tt>-1</tt> to have this <tt>KeyFrameControl</tt>
	 *                          choose at which index it is to be added in accord
	 *                          with its internal logic through this
	 *                          <tt>KeyFrameControl</tt>
	 * @param keyFrameRequestee the <tt>KeyFrameRequestee</tt> to be added to this
	 *                          <tt>KeyFrameControl</tt> so that it is made
	 ...
	 *
	 * @param index             the zero-based index at which
	 *                          <tt>keyFrameRequester</tt> is to be added to the
	 *                          list of <tt>KeyFrameRequester</tt>s made available
	 *                          or <tt>-1</tt> to have this <tt>KeyFrameControl</tt>
	 *                          choose at which index it is to be added in accord
	 *                          with its internal logic through this
	 *                          <tt>KeyFrameControl</tt>
	 * @param keyFrameRequester the <tt>KeyFrameRequester</tt> to be added to this
	 *                          <tt>KeyFrameControl</tt> so that it is made
	 *                          available through it
	 */
	 ...
	 * <tt>KeyFrameControl</tt>.
	 *
	 * @return an unmodifiable list of <tt>KeyFrameRequestee</tt>s made available
	 ...
	 * <tt>KeyFrameControl</tt>.
	 *
	 * @return an unmodifiable list of <tt>KeyFrameRequester</tt>s made available
	 *         through this <tt>KeyFrameControl</tt>
	 */
	...
	/**
	 * Removes a <tt>KeyFrameRequestee</tt> to no longer be made available through
	 * this <tt>KeyFrameControl</tt>.
	 *
	 * @param keyFrameRequestee the <tt>KeyFrameRequestee</tt> to be removed from
	 *                          this <tt>KeyFrameControl</tt> so that it is no
	 *                          longer made available through it
	...
	/**
	 * Removes a <tt>KeyFrameRequester</tt> to no longer be made available through
	 * this <tt>KeyFrameControl</tt>.
	 *
	 * @param keyFrameRequester the <tt>KeyFrameRequester</tt> to be removed from
	 *                          this <tt>KeyFrameControl</tt> so that it is no
	 *                          longer made available through it
	 ...
	 * <tt>VideoMediaStream</tt>.
	 *
	 * @param urgent <tt>true</tt> if the caller has determined that the need for a
	 ...
	 *         peer of the associated <tt>VideoMediaStream</tt> in response to the
	...
	public interface KeyFrameRequestee {
		 ...
		 * associated <tt>VideoMediaStream</tt> requests a key frame from the local
		 * peer.
		 *
		 * @return <tt>true</tt> if this <tt>KeyFrameRequestee</tt> has honored the
		 *         request for a key frame; otherwise, <tt>false</tt>
		 */
		public boolean keyFrameRequest();
	}

	/**
	 * Represents a way for a <tt>VideoMediaStream</tt> to request a key frame from
	 * its remote peer.
	 *
	 * @author Lyubomir Marinov
	 */
	public interface KeyFrameRequester {
		 ...
		 * preferred <tt>KeyFrameRequester</tt> to be used.
		 */
		...
		/**
		 * The value of the {@link #PREFERRED_PNAME} <tt>ConfigurationService</tt>
		 * property which indicates that the RTCP <tt>KeyFrameRequester</tt> is
		 * preferred.
		 */
		...
		/**
		 * The value of the {@link #PREFERRED_PNAME} <tt>ConfigurationService</tt>
		 * property which indicates that the signaling/protocol
