...
public interface SrtpControl {
	 ...
	 * <tt>org.jitsi.impl.neomedia.transform.TransformEngine</tt> which is to go in
	 * hand with the <tt>cleanup()</tt> method of <tt>SrtpControl</tt>.
	 *
	...
	/**
	 * Gets the default secure/insecure communication status for the supported call
	 * sessions.
	 *
	...
	/**
	 * Indicates if the key exchange method is dependent on secure transport of the
	 * signaling channel.
	 *
	 ...
	 *
	 * @param connector the <tt>RTPConnector</tt> which is to use or uses this SRTP
	 *                  engine
	 */
	 ...
	 * successfully started and this will start all other streams in this session.
	 *
