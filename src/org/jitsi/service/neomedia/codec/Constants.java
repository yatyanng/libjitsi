...
public class Constants {
	...
	/**
	 * The Android Surface constant. It is used as VideoFormat pseudo encoding in
	 * which case the object is passed through the buffers instead of byte array for
	 * example.
	 */
	...
	/**
	 * The name of the property used to control the Opus encoder "audio bandwidth"
	 * setting
	 */
	...
	/**
	 * The name of the property used to control whether FEC is enabled for the Opus
	 * encoder
	 */
	...
	/**
	 * The name of the property used to control the Opus encoder "minimum expected
	 * packet loss" setting
	 */
	...
	/**
	 * The name of the property used to control whether VBR is enabled for the Opus
	 * encoder
	 */
	public static final String PROP_OPUS_VBR = "net.java.sip.communicator.impl.neomedia.codec.audio.opus.encoder"
			+ ".VBR";

	/**
	 * The name of the property used to control whether FEC support is advertised
	 * for SILK
	 */
	...
	/**
	 * The name of the property used to control the the 'always assume packet loss'
	 * setting for SILK
	 */
