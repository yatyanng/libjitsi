 ...
 * class. This is desirable in order to: 1. Help to keep the old interface for
 * backward compatibility. 2. Provide a "clean" place where future code can be
 * added, thus avoiding further cluttering of the already overly complicated
...
public interface MediaStreamStats2 extends MediaStreamStats {
	...
	/**
	 * @return the instance which keeps statistics for a particular SSRC in the send
	 *         direction.
	 */
