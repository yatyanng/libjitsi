...
public interface RemoteBitrateEstimator extends CallStatsObserver {
	...
	/**
	 * Returns the estimated payload bitrate in bits per second if a valid estimate
	 * exists; otherwise, <tt>-1</tt>.
	 *
	 * @return the estimated payload bitrate in bits per seconds if a valid estimate
	 *         exists; otherwise, <tt>-1</tt>
	 */
