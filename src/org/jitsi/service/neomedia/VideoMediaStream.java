...
public interface VideoMediaStream extends MediaStream {
	 ...
	 *         rendered
	 * @deprecated Since multiple videos may be received from the remote peer and
	 *             rendered, it is not clear which one of them is to be singled out
	 *             as the return value. Thus {@link #getVisualComponent(long)} and
	...
	/**
	 * Gets the visual <tt>Component</tt> rendering the <tt>ReceiveStream</tt> with
	 * a specific SSRC.
	 *
	 ...
	 *         with the specified <tt>ssrc</tt> if any; otherwise, <tt>null</tt>
	 */
