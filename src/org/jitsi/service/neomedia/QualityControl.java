...
public interface QualityControl {
	...
	/**
	 * Changes remote send preset. This doesn't have impact of current stream. But
	 * will have on next media changes. With this we can try to change the
	 ...
	 * implement this for re-inviting the other party or just sending that media has
	 * changed.
	 * 
