...
public abstract class AbstractActiveSpeakerDetector implements ActiveSpeakerDetector {
	 ...
	 * unnecessary allocations and the undesired effects of the garbage collector.
	 */
	private static final ActiveSpeakerChangedListener[] NO_LISTENERS = new ActiveSpeakerChangedListener[0];

	/**
	 * The list of listeners to be notified by this detector when the active speaker
	 * changes.
	 */
	 ...
	 *
	 * @param ssrc the synchronization source identifier/SSRC of the active speaker
	...
	/**
	 * Gets the list of listeners to be notified by this detector when the active
	 * speaker changes.
	 *
	 * @return an array of the listeners to be notified by this detector when the
	 *         active speaker changes. If no such listeners are registered with this
