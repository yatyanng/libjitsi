...
public class MediaException extends Exception {
	...
	/**
	 * Initializes a new <tt>MediaException</tt> instance with a specific detailed
	 * message and {@link #GENERAL_ERROR} error code.
	 *
	...
	/**
	 * Initializes a new <tt>MediaException</tt> instance with a specific detailed
	 * message and a specific error code.
	 *
	 * @param message   the detailed message to initialize the new instance with
	 * @param errorCode the error code which is to give more information about the
	...
	/**
	 * Initializes a new <tt>MediaException</tt> instance with a specific detailed
	 * message, {@link #GENERAL_ERROR} error code and a specific <tt>Throwable</tt>
	 * cause.
	 *
	 * @param message the detailed message to initialize the new instance with
	...
	/**
	 * Initializes a new <tt>MediaException</tt> instance with a specific detailed
	 * message, a specific error code and a specific <tt>Throwable</tt> cause.
	 *
	 * @param message   the detailed message to initialize the new instance with
	 * @param errorCode the error code which is to give more information about the
	 *                  specifics of the new instance
	 * @param cause     the <tt>Throwable</tt> which is to be carried by the new
	 *                  instance and which is to be reported as the cause for
	 *                  throwing the new instance. If <tt>cause</tt> is
	 *                  <tt>null</tt>, the cause for throwing the new instance is
	...
	/**
	 * Gets the error code carried by this <tt>MediaException</tt> which gives more
	 * information about the specifics of this <tt>MediaException</tt>.
	 *
	 * @return the error code carried by this <tt>MediaException</tt> which gives
