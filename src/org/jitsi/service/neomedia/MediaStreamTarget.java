...
public class MediaStreamTarget {
	...
	/**
	 * Initializes a new <tt>MediaStreamTarget</tt> instance with specific RTP and
	 * RTCP <tt>InetSocketAddress<tt>es.
	 *
	 * @param rtpTarget the <tt>InetSocketAddress</tt> that the new instance is to
	 *                   indicate as a data/RTP address.
	 * 
	 * @param rtcpTarget the <tt>InetSocketAddress</tt> that the new instance is to
	...
	/**
	 * Initializes a new <tt>MediaStreamTarget</tt> instance with specific RTP and
	 * RTCP <tt>InetAddress</tt>es and ports.
	 *
	 * @param rtpAddr  the <tt>InetAddress</tt> that the new instance is to indicate
	 *                 as the IP address of a data/RTP address
	 * @param rtpPort  the port that the new instance is to indicate as the port of
	 *                 a data/RTP address
	 * @param rtcpAddr the <tt>InetAddress</tt> that the new instance is to indicate
	 *                 as the IP address of a control/RTCP address
	 * @param rtcpPort the port that the new instance is to indicate as the port of
	 *                 a control/RTCP address
	 */
	...
	/**
	 * Returns a human-readable representation of this <tt>MediaStreamTarget</tt>
	 * instance in the form of a <tt>String</tt> value.
	 *
	 * @return a <tt>String</tt> value which gives a human-readable representation
	 *         of this <tt>MediaStreamTarget</tt> instance
	 */
	@Override
	public String toString() {
		return getClass().getSimpleName() + " with dataAddress " + getDataAddress() + " and controlAddress "
				+ getControlAddress();
	}
}
