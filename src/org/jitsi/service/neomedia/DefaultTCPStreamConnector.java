...
public class DefaultTCPStreamConnector implements StreamConnector {
	...
	/**
	 * Initializes a new <tt>DefaultTCPStreamConnector</tt> instance with no control
	 * and data <tt>Socket</tt>s.
	 * <p>
	 ...
	 *
	 * @param dataSocket    the <tt>Socket</tt> to be used for data (e.g. RTP)
	 *                      traffic
	 * @param controlSocket the <tt>Socket</tt> to be used for control data (e.g.
	 *                      RTCP) traffic
	 */
