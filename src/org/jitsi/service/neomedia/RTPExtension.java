...
public class RTPExtension {
	 ...
	 * conference participants the audio levels of all contributing sources. Defined
	 * in RFC6465.
	 */
	...
	/**
	 * The URN which identifies the Original Header Block RTP extension defined in
	 * {@link "https://tools.ietf.org/html/draft-ietf-perc-double-02"}.
	 */
	...
	/**
	 * The URN which identifies the rtp-stream-id extensions in
	 * {@link "https://tools.ietf.org/html/draft-ietf-mmusic-rid-10"}.
	 */
	public static final String RTP_STREAM_ID_URN = "urn:ietf:params:rtp-hdrext:sdes:rtp-stream-id";

	/**
	 * The URN which identifies the transmission time-offset extensions in
	 * {@link "https://tools.ietf.org/html/rfc5450"}.
	 */
	 ...
	 *
	 * @param extensionURI the <tt>URI</tt> (possibly a URN) of the RTP extension
	 ...
	 * @param extensionURI        the <tt>URI</tt> (possibly a URN) of the RTP
	 *                            extension that we'd like to create.
	 * @param direction           a <tt>MediaDirection</tt> instance indication how
	 *                            this extension will be transmitted.
	 * @param extensionAttributes any attributes that we'd like to add to this
	 *                            extension.
	 */
	...
	/**
	 * Returns the direction that the corresponding <tt>MediaDevice</tt> supports
	 * for this extension. By default RTP extension headers inherit the direction of
	 * a stream. When explicitly specified <tt>SENDONLY</tt> direction indicates an
	 * ability to attach the extension in outgoing RTP packets; a <tt>RECVONLY</tt>
	 * direction indicates a desire to receive the extension in incoming packets; a
	 * <tt>SENDRECV</tt> direction indicates both. An <tt>INACTIVE</tt> direction
	 * indicates neither, but later re-negotiation may make an extension active.
	 *
	 * @return the direction that the corresponding <tt>MediaDevice</tt> supports
	 *         for this extension.
	 */
	...
	/**
	 * Returns the extension attributes associated with this <tt>RTPExtension</tt>
	 * or <tt>null</tt> if this extension does not have any.
	 *
	 * @return A <tt>String</tt> containing the extension attributes associated with
	 *         this <tt>RTPExtension</tt> or <tt>null</tt> if this extension does
	 *         not have any.
	 */
	...
	/**
	 * Returns the hash code of this extension instance which is actually the hash
	 * code of the <tt>URI</tt> that this extension is encapsulating.
	 *
	 * @return the hash code of this extension instance which is actually the hash
	 *         code of the <tt>URI</tt> that this extension is encapsulating.
	 */
	@Override
	public int hashCode() {
