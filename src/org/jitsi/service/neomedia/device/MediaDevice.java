...
public interface MediaDevice {
	...
	/**
	 * Returns the <tt>List</tt> of <tt>RTPExtension</tt>s that this device know how
	 * to handle.
	 *
	 * @return the <tt>List</tt> of <tt>RTPExtension</tt>s that this device know how
	 *         to handle or <tt>null</tt> if the device does not support any RTP
	 *         extensions.
	 */
