...
public class QualityPreset implements Comparable<QualityPreset> {
	...
	/**
	 * Initializes a new quality preset with a specific <tt>resolution</tt> and a
	 * specific <tt>frameRate</tt>.
	 *
	...
	/**
	 * Initializes a new quality preset with a specific <tt>resolution</tt> and an
	 * unspecified <tt>frameRate</tt>.
	 *
	 * @param resolution the resolution
	 */
