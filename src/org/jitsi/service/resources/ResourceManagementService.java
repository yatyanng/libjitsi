...
public interface ResourceManagementService {
	 ...
	 * @return An internationalized string corresponding to the given key and given
	 *         locale.
	 */
	...
	/**
	 * Returns an url for the setting corresponding to the given key. Used when the
	...
	/**
	 * Returns an InputStream for the setting corresponding to the given key. Used
	 * when the setting is an actual file.
	 *
	...
	/**
	 * Returns a stream from a given identifier, obtained through the class loader
	 * of the given resourceClass.
	 *
	 * @param streamKey     The identifier of the stream.
	 * @param resourceClass the resource class through which the resource would be
	 *                      obtained
