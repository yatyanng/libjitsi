...
public abstract class AbstractVersion implements Version {
	 ...
	 *
	 * @return a String containing a nightly build identifier or null if this is a
	 *         release version and therefore not a nightly build
	 */
	@Override
	 ...
	 * <build-num>.<revision> we will first try to compare them by splitting the id
	 * in components and compare them one by one asnumbers
	 * 
	 * @param v1 the first version to compare
	 * @param v2 the second version to compare
	 * @return a negative integer, zero, or a positive integer as the first
	 *         parameter <tt>v1</tt> represents a version that is earlier, same, or
	 *         more recent than the one referenced by the <tt>v2</tt> parameter.
	 */
	...
	/**
	 * Returns a String representation of this Version instance in the generic form
	 * of major.minor[.nightly.build.id]. If you'd just like to obtain the version
	 * of Jitsi so that you could display it (e.g. in a Help->About dialog) then all
	 * you need is calling this method.
	 *
