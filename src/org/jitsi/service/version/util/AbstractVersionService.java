...
public abstract class AbstractVersionService implements VersionService {
	...
	public Version parseVersionString(String version) {
		...
		if (matcher.matches() && matcher.groupCount() == 3) {
			return createVersionImpl(Integer.parseInt(matcher.group(1)), Integer.parseInt(matcher.group(2)),
					matcher.group(3));
		}
	 ...
	 * @return new <tt>Version</tt> instance specific to current implementation for
	 *         given major, minor and nightly build id parameters.
	 */
