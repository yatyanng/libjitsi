...
public interface SCAudioClip {
	 ...
	 *                      plays of this audio. If negative, this audio is played
	 *                      once only and <tt>loopCondition</tt> is ignored.
	 * @param loopCondition a <tt>Callable</tt> which is called at the beginning of
	 *                      each iteration of looped playback of this audio except
	 *                      the first one to determine whether to continue the loop.
	 *                      If <tt>loopInterval</tt> is negative or
	 *                      <tt>loopCondition</tt> is <tt>null</tt>, this audio is
	 *                      played once only.
	 */
