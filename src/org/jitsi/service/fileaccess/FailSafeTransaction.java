...
public interface FailSafeTransaction {
	/**
	 * Ensure that the file accessed is in a coherent state. This function is useful
	 * to do a failsafe read without starting a transaction.
	 *
	 * @throws IllegalStateException if the file doesn't exists anymore
	 * @throws IOException           if an IOException occurs during the file
	 *                               restoration
	 */
	 ...
	 * changes and begin a new transaction. A transaction can be closed by a commit
	 * or rollback operation. When the transaction begins, the file is restored to a
	 * coherent state if needed.
	 *
	 * @throws IllegalStateException if the file doesn't exists anymore
	...
	/**
	 * Closes the transaction and commit the changes. Everything written in the file
	 * during the transaction is saved.
	 *
	 * @throws IllegalStateException if the file doesn't exists anymore
	...
	/**
	 * Closes the transation and cancel the changes. Everything written in the file
	 * during the transaction is NOT saved.
	 * 
	 * @throws IllegalStateException if the file doesn't exists anymore
	 * @throws IOException           if an IOException occurs during the operation
	 */
