...
public interface FileAccessService {
	...
	/**
	 * This method returns a created temporary directory. Any file you create in it
	 * will be a temporary file.
	 *
	 * Note: If there is no opened file in this directory it may be deleted at any
	 * time. Note: DO NOT store unencrypted sensitive information in this directory
	 *
