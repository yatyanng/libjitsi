...
public class PacketLoggingConfiguration {
	...
	/**
	 * Configuration property for enabling/disabling arbitrary packet logging. The
	 * default value is {@code false} because the arbitrary packet logging was
	 * designed for the purposes of debugging, it dramatically increases the number
	 * of logged packets and, thus, noticeably impacts the performance of the
	 * library.
	 */
	public final static String PACKET_LOGGING_ARBITRARY_ENABLED_PROPERTY_NAME = "net.java.sip.communicator.packetlogging."
	...
	/**
	 * Is {@code PacketLoggingService} enabled for arbitrary packets. The arbitrary
	 * packet logging was designed for the purposes of debugging. Its use in
	 * production environments is discouraged because it dramatically increases the
	 * number of logged packets and, thus, noticeably impacts the performance of the
	 * library.
	 */
	...
	/**
	 * Checks whether packet logging is enabled in this configuration for arbitrary
	 * packets.
	 *
