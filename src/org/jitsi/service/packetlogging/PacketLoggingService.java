...
public interface PacketLoggingService {
	 ...
	 *
	 * @return {@code true} if packet logging is globally enabled for this service;
	 *         otherwise, {@code false}
	 */
	public boolean isLoggingEnabled();

	/**
	 * Determines whether packet logging for a specific protocol is enabled for this
	 * service.
	 *
	 * @param protocol the packet logging protocol to check
	 * @return {@code true} if packet logging for {@code protocol} is enabled for
	 *         this service; otherwise, {@code false}
	 */
	 ...
	 */
	public void logPacket(ProtocolName protocol, byte[] sourceAddress, int sourcePort, byte[] destinationAddress,
			int destinationPort, TransportName transport, boolean sender, byte[] packetContent);
	 ...
	 */
	public void logPacket(ProtocolName protocol, byte[] sourceAddress, int sourcePort, byte[] destinationAddress,
			int destinationPort, TransportName transport, boolean sender, byte[] packetContent, int packetOffset,
			int packetLength);
